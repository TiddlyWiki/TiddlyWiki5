...
describe("WikiText parser tests", function () {
				...
				children: [
					{
						...
						attributes: {},
						orderedAttributes: [],
						children: [{type: "text", text: "some text", start: 5, end: 14}],
						start: 0,
						end: 20
					}
				]
				...
				children: [
					{
						...
						isBlock: false,
						attributes: {
							attribute: {type: "string", value: "true", start: 4, end: 14, name: "attribute"}
						},
						orderedAttributes: [{type: "string", value: "true", start: 4, end: 14, name: "attribute"}],
						children: [{type: "text", text: "some text", start: 15, end: 24}],
						start: 0,
						end: 30,
						openTagStart: 0,
						openTagEnd: 15,
				...
				children: [
					{
						...
						rule: "html",
						isBlock: false,
						attributes: {attribute: {type: "string", name: "attribute", value: "value", start: 4, end: 22}},
						orderedAttributes: [{type: "string", name: "attribute", value: "value", start: 4, end: 22}],
						children: [{type: "text", text: "some text", start: 23, end: 32}],
						start: 0,
						end: 38
					}
				]
				...
				children: [
					{
						...
						attributes: {
							attribute: {
								type: "indirect",
								name: "attribute",
								textReference: "TiddlerTitle",
								start: 4,
								end: 31
							}
						},
						orderedAttributes: [
							{type: "indirect", name: "attribute", textReference: "TiddlerTitle", start: 4, end: 31}
						],
						children: [{type: "text", text: "some text", start: 32, end: 41}],
						start: 0,
						end: 47,
						openTagStart: 0,
						openTagEnd: 32,
				...
				children: [
					{
						...
						rule: "html",
						attributes: {
							state: {start: 8, name: "state", type: "string", value: "$:/temp/search", end: 31},
							type: {start: 31, name: "type", type: "string", value: "nomatch", end: 46},
							text: {start: 46, name: "text", type: "string", value: "", end: 54}
						},
						orderedAttributes: [
							{start: 8, name: "state", type: "string", value: "$:/temp/search", end: 31},
							{start: 31, name: "type", type: "string", value: "nomatch", end: 46},
							{start: 46, name: "text", type: "string", value: "", end: 54}
						],
						start: 0,
						end: 55,
						openTagStart: 0,
				...
				children: [
					{
						...
						attributes: {
							attribute: {
								type: "indirect",
								name: "attribute",
								textReference: "TiddlerTitle!!field",
								start: 4,
								end: 38
							}
						},
						...
						children: [{type: "text", text: "some text", start: 39, end: 48}],
						start: 0,
						end: 54,
						openTagStart: 0,
						openTagEnd: 39,
				...
				children: [
					{
						...
						attributes: {
							attribute: {
								type: "indirect",
								name: "attribute",
								textReference: "Tiddler Title!!field",
								start: 4,
								end: 39
							}
						},
						...
						children: [{type: "text", text: "some text", start: 40, end: 49}],
						start: 0,
						end: 55,
						openTagStart: 0,
						openTagEnd: 40,
		...
		expect(parse("<div attribute={{TiddlerTitle!!field}}>\n\nsome text</div>")).toEqual([
			{
				...
				orderedAttributes: [
					{start: 4, name: "attribute", type: "indirect", textReference: "TiddlerTitle!!field", end: 38}
				],
				tag: "div",
				rule: "html",
				end: 56,
				...
				children: [
					{
						...
						children: [{type: "text", text: "some text", start: 41, end: 50}]
					}
				]
			}
		]);
								...
								children: [
									{
										...
										children: [{type: "text", text: "some text", start: 46, end: 55}]
									}
								]
							}
						]
								...
								children: [
									{
										...
										rule: "heading",
										attributes: {class: {type: "string", value: "", start: 47, end: 47}},
										children: [{type: "text", text: "some heading</div></div>", start: 47, end: 71}]
									}
								]
							}
						]
										...
										children: [
											{
												...
												children: [{type: "text", text: "Some text", start: 19, end: 28}]
											}
										]
									}
								]
		...
		expect(parse("\\define myMacro()\nnothing\n\\end\n")).toEqual([
			{
				type: "set",
				attributes: {
					name: {name: "name", type: "string", value: "myMacro"},
					value: {name: "value", type: "string", value: "nothing"}
				},
				children: [],
				params: [],
				isMacroDefinition: true,
				orderedAttributes: [
					{name: "name", type: "string", value: "myMacro"},
					{name: "value", type: "string", value: "nothing"}
				],
				start: 0,
				end: 30,
				rule: "macrodef"
		...
		expect(parse("\\procedure myMacro(one,two,three,four:elephant)\nnothing\n\\end\n")).toEqual([
			{
				...
				children: [],
				params: [{name: "one"}, {name: "two"}, {name: "three"}, {name: "four", default: "elephant"}],
				orderedAttributes: [
					{name: "name", type: "string", value: "myMacro"},
					{name: "value", type: "string", value: "nothing"}
				],
		...
		expect(parse("\\procedure myMacro(one:'Jaguar')\n<$text text=<<one>>/>\n\\end\n\n")).toEqual([
			{
				...
				attributes: {
					name: {name: "name", type: "string", value: "myMacro"},
					value: {name: "value", type: "string", value: "<$text text=<<one>>/>"}
				},
				children: [],
				params: [{name: "one", default: "Jaguar"}],
				orderedAttributes: [
					{name: "name", type: "string", value: "myMacro"},
					{name: "value", type: "string", value: "<$text text=<<one>>/>"}
				],
				isProcedureDefinition: true,
				start: 0,
				end: 59,
		...
		expect(parse("<!-- comment in pragma area -->\n\\define aMacro()\nnothing\n\\end\n")).toEqual([
			{
				type: "set",
				attributes: {
					name: {name: "name", type: "string", value: "aMacro"},
					value: {name: "value", type: "string", value: "nothing"}
				},
				children: [],
				params: [],
				isMacroDefinition: true,
				orderedAttributes: [
					{name: "name", type: "string", value: "aMacro"},
					{name: "value", type: "string", value: "nothing"}
				],
				start: 32,
				end: 61,
	...
	it("should block mode filtered transclusions", function () {
		expect(parse("{{{ filter }}}")).toEqual([
			{
				type: "list",
				attributes: {filter: {type: "string", value: " filter ", start: 3, end: 11}},
				isBlock: true,
				start: 0,
				end: 14,
				rule: "filteredtranscludeblock"
			}
		]);
		expect(parse("{{{ fil\nter }}}")).toEqual([
			{
				type: "list",
				attributes: {filter: {type: "string", value: " fil\nter ", start: 3, end: 12}},
				isBlock: true,
				start: 0,
				end: 15,
				rule: "filteredtranscludeblock"
	...
	it("should parse inline macro calls", function () {
				...
				children: [
					{
						...
						orderedAttributes: [{name: "$variable", type: "string", value: "john"}]
					},
					{
						type: "transclude",
						start: 8,
						...
						rule: "macrocallinline",
						attributes: {$variable: {name: "$variable", type: "string", value: "paul"}},
						orderedAttributes: [{name: "$variable", type: "string", value: "paul"}]
					},
					{
						type: "transclude",
						start: 16,
						...
						rule: "macrocallinline",
						attributes: {$variable: {name: "$variable", type: "string", value: "george"}},
						orderedAttributes: [{name: "$variable", type: "string", value: "george"}]
					},
					{
						type: "transclude",
						start: 26,
						...
						rule: "macrocallinline",
						attributes: {$variable: {name: "$variable", type: "string", value: "ringo"}},
						orderedAttributes: [{name: "$variable", type: "string", value: "ringo"}]
					}
				],
				start: 0,
				end: 35
		...
		expect(
			parse('text <<john one:val1 two: \'val "2"\' three: "val \'3\'" four: """val 4"5\'""" five: [[val 5]] >>')
		).toEqual([
			{
				type: "element",
				tag: "p",
				children: [
					{type: "text", text: "text ", start: 0, end: 5},
					{
						...
						rule: "macrocallinline",
						attributes: {
							$variable: {name: "$variable", type: "string", value: "john"},
		...
		expect(parse("ignored << carrots <<john>>")).toEqual([
			{
				...
				tag: "p",
				children: [
					{type: "text", text: "ignored << carrots ", start: 0, end: 19},
					{
						type: "transclude",
						start: 19,
						end: 27,
		...
		expect(parse("text <<outie one:'my <<innie>>' >>")).toEqual([
			{
				...
				children: [
					{type: "text", text: "text ", start: 0, end: 5},
					{
						...
						rule: "macrocallinline",
						attributes: {
							$variable: {name: "$variable", type: "string", value: "outie"},
							one: {name: "one", type: "string", value: "my <<innie>>", start: 12, end: 31}
						},
						orderedAttributes: [
							{name: "$variable", type: "string", value: "outie"},
							{name: "one", type: "string", value: "my <<innie>>", start: 12, end: 31}
						]
					}
				],
				start: 0,
	...
	it("should parse block macro calls", function () {
		...
		expect(
			parse('<<john one:val1 two: \'val "2"\' three: "val \'3\'" four: """val 4"5\'""" five: [[val 5]] >>')
		).toEqual([
			{
				type: "transclude",
				start: 0,
				...
				attributes: {
					$variable: {name: "$variable", type: "string", value: "john"},
					one: {name: "one", type: "string", value: "val1", start: 6, end: 15},
					two: {name: "two", type: "string", value: 'val "2"', start: 15, end: 30},
					three: {name: "three", type: "string", value: "val '3'", start: 30, end: 47},
					four: {name: "four", type: "string", value: "val 4\"5'", start: 47, end: 68},
					five: {name: "five", type: "string", value: "val 5", start: 68, end: 84}
				},
				orderedAttributes: [
					{name: "$variable", type: "string", value: "john"},
					{name: "one", type: "string", value: "val1", start: 6, end: 15},
					{name: "two", type: "string", value: 'val "2"', start: 15, end: 30},
					{name: "three", type: "string", value: "val '3'", start: 30, end: 47},
					{name: "four", type: "string", value: "val 4\"5'", start: 47, end: 68},
					{name: "five", type: "string", value: "val 5", start: 68, end: 84}
				],
				isBlock: true
			}
		]);
		expect(parse("<< carrots\n\n<<john>>")).toEqual([
			{
				...
				children: [{type: "text", text: "<< carrots", start: 0, end: 10}]
			},
			{
				type: "transclude",
				start: 12,
		...
		expect(parse("<<john>>\nafter")).toEqual([
			...
			},
			{
				...
				children: [{type: "text", text: "after", start: 9, end: 14}]
			}
		]);
		expect(parse('<<multiline arg:"""\n\nwikitext\n""" >>')).toEqual([
			{
				...
				rule: "macrocallblock",
				attributes: {
					$variable: {name: "$variable", type: "string", value: "multiline"},
					arg: {name: "arg", type: "string", value: "\n\nwikitext\n", start: 11, end: 33}
				},
				orderedAttributes: [
					{name: "$variable", type: "string", value: "multiline"},
					{name: "arg", type: "string", value: "\n\nwikitext\n", start: 11, end: 33}
				],
				isBlock: true
			}
		]);
		expect(parse("<<outie one:'my <<innie>>' >>")).toEqual([
			{
				...
				attributes: {
					$variable: {name: "$variable", type: "string", value: "outie"},
					one: {name: "one", type: "string", value: "my <<innie>>", start: 7, end: 26}
				},
				orderedAttributes: [
					{name: "$variable", type: "string", value: "outie"},
					{name: "one", type: "string", value: "my <<innie>>", start: 7, end: 26}
				],
				end: 29,
				isBlock: true
			}
		...
		expect(parse("<<john pa>am>>")).toEqual([
			{
				...
				attributes: {
					0: {name: "0", type: "string", value: "pa>am", start: 6, end: 12},
					$variable: {name: "$variable", type: "string", value: "john"}
				},
				orderedAttributes: [
					{name: "$variable", type: "string", value: "john"},
					{name: "0", type: "string", value: "pa>am", start: 6, end: 12}
				],
				isBlock: true,
				rule: "macrocallblock"
			}
		...
		expect(parse("<<john param> >>")).toEqual([
			{
				...
				attributes: {
					0: {name: "0", type: "string", value: "param>", start: 6, end: 13},
					$variable: {name: "$variable", type: "string", value: "john"}
				},
				orderedAttributes: [
					{name: "$variable", type: "string", value: "john"},
					{name: "0", type: "string", value: "param>", start: 6, end: 13}
				],
				isBlock: true,
				rule: "macrocallblock"
			}
				...
				children: [
					{
						...
						rule: "macrocallinline",
						attributes: {
							0: {name: "0", type: "string", value: "param", start: 6, end: 12},
							$variable: {name: "$variable", type: "string", value: "john"}
						},
						orderedAttributes: [
							{name: "$variable", type: "string", value: "john"},
							{name: "0", type: "string", value: "param", start: 6, end: 12}
						]
					},
					{type: "text", text: ">", start: 14, end: 15}
				],
				start: 0,
				end: 15
			}
		...
		expect(parse("<<john var>=4 >>")).toEqual([
			{
				...
				attributes: {
					0: {name: "0", type: "string", value: "var>=4", start: 6, end: 13},
					$variable: {name: "$variable", type: "string", value: "john"}
				},
				orderedAttributes: [
					{name: "$variable", type: "string", value: "john"},
					{name: "0", type: "string", value: "var>=4", start: 6, end: 13}
				],
				isBlock: true,
				rule: "macrocallblock"
			}
		...
		expect(parse("---Not a rule\n\n----\n\nBetween\n\n---")).toEqual([
			{
				...
				children: [
					{type: "entity", entity: "&mdash;", start: 0, end: 3, rule: "dash"},
					{type: "text", text: "Not a rule", start: 3, end: 13}
				]
			},
			{type: "element", tag: "hr", start: 15, end: 20, rule: "horizrule"},
			{
				type: "element",
				tag: "p",
				start: 21,
				end: 28,
				children: [{type: "text", text: "Between", start: 21, end: 28}]
			},
			{type: "element", tag: "hr", start: 30, end: 33, rule: "horizrule"}
		]);
	});
		...
		expect(parse('"""Something\nin the\nway she moves\n"""\n\n')).toEqual([
			{
				...
				tag: "p",
				children: [
					{type: "text", text: "Something", start: 3, end: 12, rule: "hardlinebreaks"},
					{type: "element", tag: "br", rule: "hardlinebreaks", start: 12, end: 13},
					{type: "text", text: "in the", start: 13, end: 19, rule: "hardlinebreaks"},
					{type: "element", tag: "br", rule: "hardlinebreaks", start: 19, end: 20},
					{type: "text", text: "way she moves", start: 20, end: 33, rule: "hardlinebreaks"},
					{type: "element", tag: "br", rule: "hardlinebreaks", start: 33, end: 34}
				],
				start: 0,
				end: 37
			}
						...
						children: [
							{
								...
								orderedAttributes: [{name: "class", type: "string", value: "evenRow"}],
								start: 0,
								end: 18,
								children: [
									{
										...
										orderedAttributes: [{name: "align", type: "string", value: "left"}],
										start: 1,
										end: 8,
							...
							},
							{
								...
								orderedAttributes: [{name: "class", type: "string", value: "oddRow"}],
								start: 18,
								end: 33,
								children: [
									{
