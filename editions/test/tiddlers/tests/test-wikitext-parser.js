...
describe("WikiText parser tests", function() {
    ...
    it("should parse HTML elements", function() {
        expect(parse("<div>\n<div>\n\n<strong>Hello World</strong>\n\n</div>\n</div>")).toEqual(
            ...
            [ { type : 'element', tag : 'div', start : 0, end : 5, attributes : { }, orderedAttributes : [ ], isBlock : true, children : [ { type : 'text', text : '\n', start : 5, end : 6 }, { type : 'element', tag : 'div', start : 6, end : 11, attributes : { }, orderedAttributes : [ ], isBlock : true, children : [ { type : 'element', tag : 'p', start : 13, end : 41, children : [ { type : 'element', tag : 'strong', start : 13, end : 21, attributes : { }, orderedAttributes : [ ], isBlock : false, children : [ { type : 'text', text : 'Hello World', start : 21, end : 32 } ] } ] } ] }, { type : 'text', text : '\n', start : 49, end : 50 } ] } ]

        );
    });

    it("should parse HTML self closing elements", function() {
        expect(parse("<div/>")).toEqual(

            [ { type : 'element', tag : 'div', start : 0, end : 6, attributes : { }, orderedAttributes : [ ], isBlock : true, isSelfClosing : true } ]

        );
    });

    it("should parse HTML void elements", function() {
        expect(parse("<img>")).toEqual(

            [ { type : 'element', tag : 'img', start : 0, end : 5, attributes : { }, orderedAttributes : [ ], isBlock : true } ]

        );
    });

    it("should add missing closing tags at the end of input", function() {
        expect(parse("<div>\n<span></span>")).toEqual(

            [ { type : 'element', tag : 'div', start : 0, end : 5, attributes : { }, orderedAttributes : [ ], isBlock : true, children : [ { type : 'text', text : '\n', start : 5, end : 6 }, { type : 'element', tag : 'span', start : 6, end : 12, attributes : { }, orderedAttributes : [ ], isBlock : false, children : [ ] } ] } ]

        );
    });

    it("should parse structurally invalid HTML as raw text", function() {
        expect(parse("<div>\n<span>\n</div>")).toEqual(

            [ { type : 'element', tag : 'div', start : 0, end : 5, attributes : { }, orderedAttributes : [ ], isBlock : true, children : [ { type : 'text', text : '\n', start : 5, end : 6 }, { type : 'element', tag : 'span', start : 6, end : 12, attributes : { }, orderedAttributes : [ ], isBlock : false, children : [ { type : 'text', text : '\n</div>', start : 12, end : 19 } ] } ] } ]

        );
        expect(parse("div><span></span></div>")).toEqual(

            [ { type : 'element', tag : 'p', start : 0, end : 23, children : [ { type : 'text', text : 'div>', start : 0, end : 4 }, { type : 'element', tag : 'span', start : 4, end : 10, attributes : { }, orderedAttributes : [ ], isBlock : false, children : [ ] }, { type : 'text', text : '</div>', start : 17, end : 23 } ] } ]

        );
    });
    it("should parse WikiText block elements", function() {
        expect(parse("! Heading\n\n* list")).toEqual(

            [ { type : 'element', tag : 'h1', attributes : { class : { type : 'string', value : '' } }, children : [ { type : 'text', text : 'Heading', start : 2, end : 9 } ] }, { type : 'element', tag : 'ul', children : [ { type : 'element', tag : 'li', children : [ { type : 'text', text : 'list', start : 13, end : 17 } ] } ] } ]

        );
    });

    it("should parse WikiText inline elements", function() {
        expect(parse("//italic//, ''bold'', __underlined__")).toEqual(

            [ { type : 'element', tag : 'p', start : 0, end : 36, children : [ { type : 'element', tag : 'em', children : [ { type : 'text', text : 'italic', start : 2, end : 8 } ] }, { type : 'text', text : ', ', start : 10, end : 12 }, { type : 'element', tag : 'strong', children : [ { type : 'text', text : 'bold', start : 14, end : 18 } ] }, { type : 'text', text : ', ', start : 20, end : 22 }, { type : 'element', tag : 'u', children : [ { type : 'text', text : 'underlined', start : 24, end : 34 } ] } ] } ]

        );
    });

    it("should wrap blocks of text and WikiText inline elements in paragraphs", function() {
        expect(parse("paragraph\n\nanother paragraph\n\n//another// paragraph")).toEqual(

            [ { type : 'element', tag : 'p', start : 0, end : 9, children : [ { type : 'text', text : 'paragraph', start : 0, end : 9 } ] }, { type : 'element', tag : 'p', start : 11, end : 28, children : [ { type : 'text', text : 'another paragraph', start : 11, end : 28 } ] }, { type : 'element', tag : 'p', start : 30, end : 51, children : [ { type : 'element', tag : 'em', children : [ { type : 'text', text : 'another', start : 32, end : 39 } ] }, { type : 'text', text : ' paragraph', start : 41, end : 51 } ] } ]

        );
    });

    it("should wrap an element in a p and parse the children in inline mode", function() {
    // ... when there 
    // * are at least two newlines or start of input before the opening tag
    // * is no newline after the opening tag
        expect(parse("<span>! Not a heading</span>")).toEqual(

            [ { type : 'element', tag : 'p', start : 0, end : 28, children : [ { type : 'element', tag : 'span', start : 0, end : 6, attributes : { }, orderedAttributes : [ ], isBlock : false, children : [ { type : 'text', text : '! Not a heading', start : 6, end : 21 } ] } ] } ]

        );
    });

    it("should not wrap an element in a p and parse the children in inline mode", function() {
    // ... when there 
    // * are at least two newlines or start of input before the opening tag
    // * is exactly one newline after the opening tag
        expect(parse("<div>\n! Not a heading\n</div>")).toEqual(

            [ { type : 'element', tag : 'div', start : 0, end : 5, orderedAttributes : [ ], attributes : { }, isBlock : true, children : [ { type : 'text', text : '\n! Not a heading\n', start : 5, end : 22 } ] } ]

        );
    });

    it("should not wrap an element in a p and parse the children in block mode", function() {
    // ... when there 
    // * are at least two newlines or start of input before the opening tag
    // * are two or more newlines after the opening tag
        expect(parse("<div>\n\n! I am a heading\n\n</div>")).toEqual(

            [ { type : 'element', tag : 'div', start : 0, end : 5, attributes : { }, orderedAttributes : [ ], isBlock : true, children : [ { type : 'element', tag : 'h1', attributes : { class : { type : 'string', value : '' } }, children : [ { type : 'text', text : 'I am a heading', start : 9, end : 23 } ] } ] } ]

        );
        expect(parse("<div>\n\n...\n\n</div>")).toEqual(

            [ { type : 'element', tag : 'div', start : 0, end : 5, attributes : { }, orderedAttributes : [ ], isBlock : true, children : [ { type : 'element', tag : 'p', start : 7, end : 10, children : [ { type : 'text', text : '...', start : 7, end : 10 } ] } ] } ]

        );
    });

    it("should ignore an escaped line break", function() {
    // An escaped linebreak is a '\' directly after an opening tag, directly followed by a newline.
    // It throws away the '\' and the linebreak.
        expect(parse("<span>\\\n...</span>")).toEqual(

            [ { type : 'element', tag : 'p', start : 0, end : 18, children : [ { type : 'element', tag : 'span', start : 0, end : 6, attributes : { }, orderedAttributes : [ ], isBlock : false, children : [ { type : 'text', text : '...', start : 8, end : 11 } ] } ] } ]

        );
        // keep the '\' and the linebreak in other locations
        expect(parse("<span> \\\n...</span>")).toEqual(

            [ { type : 'element', tag : 'p', start : 0, end : 19, children : [ { type : 'element', tag : 'span', attributes : { }, orderedAttributes : [ ], start : 0, end : 6, isBlock : false, children : [ { type : 'text', text : ' \\\n...', start : 6, end : 12 } ] } ] } ]
    ...
    it("should trim away newlines from the start of pre and code elements", function() {
        // ... but keep indents and whitespace before and between text
        expect(parse("<pre>\nmy  block  code</pre>")).toEqual(

            [ { type : 'element', tag : 'pre', start : 0, end : 5, attributes : { }, orderedAttributes : [ ], isBlock : true, children : [ { type : 'text', text : 'my  block  code', start : 6, end : 21 } ] } ]

        );
        expect(parse("<pre>\n    my  indented  block  code</pre>")).toEqual(

            [ { type : 'element', tag : 'pre', start : 0, end : 5, attributes : { }, orderedAttributes : [ ], isBlock : true, children : [ { type : 'text', text : '    my  indented  block  code', start : 6, end : 35 } ] } ]

        );
        expect(parse("<code>    my  inline  code  wrapped  in  a  p    </code>")).toEqual(

            [ { type : 'element', tag : 'p', start : 0, end : 56, children : [ { type : 'element', tag : 'code', start : 0, end : 6, attributes : { }, orderedAttributes : [ ], isBlock : false, children : [ { type : 'text', text : '    my  inline  code  wrapped  in  a  p    ', start : 6, end : 49 } ] } ] } ]

        );
        expect(parse("<code>\n    my  inline  code    </code>")).toEqual(

            [ { type : 'element', tag : 'code', start : 0, end : 6, attributes : { }, orderedAttributes : [ ], isBlock : true, children : [ { type : 'text', text : '    my  inline  code    ', start : 7, end : 31 } ] } ]
    ...
    it("should not wrap self closing or void elements in a p, when they stand alone in a line", function() {
        expect(parse("<button/>")).toEqual(
            ...
            [ { type : 'element', tag : 'button', start : 0, end : 9, attributes : { }, orderedAttributes : [ ], isSelfClosing : true, isBlock : true } ]

        );
        expect(parse("<img>")).toEqual(

            [ { type : 'element', start : 0, attributes : { }, orderedAttributes : [ ], tag : 'img', end : 5, isBlock : true } ]

        );
        // To have p wrapping, add the closing tag ...
        expect(parse("<button></button>")).toEqual(

            [ { type : 'element', tag : 'p', start : 0, end : 17, children : [ { type : 'element', tag : 'button', start : 0, end : 8, attributes : { }, orderedAttributes : [ ], isBlock : false, children : [ ] } ] } ]

        );
        // ... or append more inline content ...
        expect(parse("<button/> Hi")).toEqual(

            [ { type : 'element', tag : 'p', start : 0, end : 12, children : [ { type : 'element', tag : 'button', start : 0, end : 9, attributes : { }, orderedAttributes : [ ], isSelfClosing : true, isBlock : false }, { type : 'text', text : ' Hi', start : 9, end : 12 } ] } ]

        );
        // ... or explicitely wrap in a p.
        expect(parse("<p>\n<img>\n</p>")).toEqual(

            [ { type : 'element', tag : 'p', start : 0, end : 3, attributes : { }, orderedAttributes : [ ], isBlock : true, children : [ { type : 'text', text : '\n', start : 3, end : 4 }, { type : 'element', tag : 'img', start : 4, end : 9, attributes : { }, orderedAttributes : [ ], isBlock : false }, { type : 'text', text : '\n', start : 9, end : 10 } ] } ]

        );
    });

    it("should handle the end of input as if it was a line break", function() {
    // Because editors or users may accidently add or trim them
    // This also applies to the end of input in macro definitions
    ...
    it("should parse linebreaks", function() {
        expect(parse("<br>")).toEqual(
            ...
            [ { type : 'element', tag : 'br', start : 0, end : 4, attributes : { }, orderedAttributes : [ ], isBlock : true } ]

        );
        expect(parse("<br/>")).toEqual(

            [ { type : 'element', tag : 'br', start : 0, end : 5, attributes : { }, orderedAttributes : [ ], isBlock : true, isSelfClosing : true } ]

        );
        expect(parse("<br></br>")).toEqual(

            [ { type : 'element', tag : 'p', start : 0, end : 9, children : [ { type : 'element', start : 0, attributes : { }, orderedAttributes : [ ], tag : 'br', end : 4, isBlock : false }, { type : 'text', text : '</br>', start : 4, end : 9 } ] } ]
    ...
    it("should parse tags with attributes", function() {
        ...
        expect(parse("<$reveal state='$:/temp/search' type='nomatch' text=''/>")).toEqual(
            ...
            [ { type : 'reveal', start : 0, attributes : { state : { start : 8, name : 'state', type : 'string', value : '$:/temp/search', end : 31 }, type : { start : 31, name : 'type', type : 'string', value : 'nomatch', end : 46 }, text : { start : 46, name : 'text', type : 'string', value : '', end : 54 } }, orderedAttributes: [ { start : 8, name : 'state', type : 'string', value : '$:/temp/search', end : 31 }, { start : 31, name : 'type', type : 'string', value : 'nomatch', end : 46 }, { start : 46, name : 'text', type : 'string', value : '', end : 54 } ], tag : '$reveal', isSelfClosing : true, end : 56, isBlock : true } ]
