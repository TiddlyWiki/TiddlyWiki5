...
describe("WikiText tests", function () {
	...
	it("should use double new lines to create paragraphs", function () {
		expect(wiki.renderTiddler("text/html", "TiddlerThree")).toBe(
			"<p>The speed of sound</p><p>The light of speed</p>"
		);
	});
	...
	it("handles inline style wikitext notation", function () {
		...
		expect(
			wiki.renderText("text/html", "text/vnd-tiddlywiki", "some @@.myClass.secondClass 2 classes@@ text")
		).toBe('<p>some <span class=" myClass secondClass ">2 classes</span> text</p>');
		expect(
			wiki.renderText("text/html", "text/vnd-tiddlywiki", "some @@background:red;.myClass style and class@@ text")
		...
		expect(
			...
			'<p>some <span class=" myClass " style="background:red;color:white;">2 style and 1 class</span> text</p>'
		);
	});
});
