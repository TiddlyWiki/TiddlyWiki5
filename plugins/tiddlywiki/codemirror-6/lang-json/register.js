/*\
title: $:/plugins/tiddlywiki/codemirror-6/lang-json/register.js
...
exports.register = function() {
	...
	*/
	...
	function ensure() {
		...
		try {
			var core = _shim;
			var langJson = require("$:/plugins/tiddlywiki/codemirror-6/lang-json/lang-json.js");
			// Register JSON
	...
	core.registerLanguage(LanguageDescription.of({
		...
		load: function() {
			...
			return Promise.resolve(_desc["JSON"] ? _desc["JSON"].support : null);
		}
	}));
};
