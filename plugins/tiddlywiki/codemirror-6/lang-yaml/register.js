/*\
title: $:/plugins/tiddlywiki/codemirror-6/lang-yaml/register.js
...
exports.register = function() {
	...
	*/
	...
	function ensure() {
		...
		try {
			var core = _shim;
			var langYaml = require("$:/plugins/tiddlywiki/codemirror-6/lang-yaml/lang-yaml.js");
			// Register YAML
	...
	core.registerLanguage(LanguageDescription.of({
		...
		load: function() {
			...
			return Promise.resolve(_desc["YAML"] ? _desc["YAML"].support : null);
		}
	}));
};
