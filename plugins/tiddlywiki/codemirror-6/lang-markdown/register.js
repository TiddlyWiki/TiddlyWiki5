/*\
title: $:/plugins/tiddlywiki/codemirror-6/lang-markdown/register.js
...
exports.register = function() {
	...
	*/
	...
	function ensure() {
		...
		try {
			var core = _shim;
			var langMarkdown = require("$:/plugins/tiddlywiki/codemirror-6/lang-markdown/lang-markdown.js");
			// Register Markdown
	...
	core.registerLanguage(LanguageDescription.of({
		...
		load: function() {
			...
			return Promise.resolve(_desc["Markdown"] ? _desc["Markdown"].support : null);
		}
	}));
};
