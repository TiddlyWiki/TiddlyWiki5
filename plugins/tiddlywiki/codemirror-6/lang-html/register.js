/*\
title: $:/plugins/tiddlywiki/codemirror-6/lang-html/register.js
...
exports.register = function() {
	...
	*/
	...
	["htmlCompletionExtension", "htmlCompletionSource", "htmlSupport"].forEach(function(prop) {
	...
	core.registerLanguage(LanguageDescription.of({
		...
		load: function() {
			...
			return Promise.resolve(_desc["HTML"] ? _desc["HTML"].support : null);
		}
	}));
};
