...
exports.SqlTiddlerStore = void 0;
const sql_tiddler_database_1 = require("./sql-tiddler-database");
const path = require("path");
class Eventer {
    constructor(skipDuplicate) {
...
class SqlTiddlerStore {
    constructor(options = {}) {
        ...
        this.eventer = new Eventer(true);
        this.addEventListener = this.eventer.addEventListener.bind(this.eventer);
        this.removeEventListener = this.eventer.removeEventListener.bind(this.eventer);
        this.dispatchEvent = this.eventer.dispatchEvent.bind(this.eventer);
        if (!(options === null || options === void 0 ? void 0 : options.attachmentStore)) {
    ...
    */
    validateItemName(name, allowPrivilegedCharacters = false) {
    ...
    */
    async getBagTiddler(title, bag_name) {
        ...
        if (tiddlerInfo) {
            return await Object.assign({}, tiddlerInfo, {
    ...
    async getBagTiddlerStream(title, bag_name) {
        ...
        if (tiddlerInfo) {
            if (tiddlerInfo.attachment_blob) {
                return $tw.utils.extend({}, this.attachmentStore.getAttachmentStream(tiddlerInfo.attachment_blob), {
...
//# sourceMappingURL=sql-tiddler-store.js.map