...
const CONFIG_CONSENT_REQUIRED_TITLE = "$:/config/cookie-consent-required"; // "yes" or "no" (the default)
const CONSENT_TITLE = "$:/state/consent-banner/accepted"; // "": undeclared, "yes": accepted, "no": declined

exports.startup = function() {
	let hasInitialised = false;
	const initialiseGoogleAnalytics = function() {
		console.log("Initialising Google Analytics");
		hasInitialised = true;
		const gaMeasurementID = $tw.wiki.getTiddlerText("$:/GoogleAnalyticsMeasurementID","").replace(/\n/g,"");
