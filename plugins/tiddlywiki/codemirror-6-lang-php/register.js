/*\
title: $:/plugins/tiddlywiki/codemirror-6-lang-php/register.js
...
exports.register = function() {
	...
	*/
	...
	function ensure() {
		...
		try {
			var core = _shim;
			var langPhp = require("$:/plugins/tiddlywiki/codemirror-6-lang-php/lang-php.js");
	...
	core.registerLanguage(LanguageDescription.of({
		...
		load: function() {
			...
			return Promise.resolve(_desc["PHP"] ? _desc["PHP"].support : null);
		}
	}));
};
