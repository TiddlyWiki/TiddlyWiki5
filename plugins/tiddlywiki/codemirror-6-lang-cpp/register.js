/*\
title: $:/plugins/tiddlywiki/codemirror-6-lang-cpp/register.js
...
exports.register = function() {
	...
	*/
	...
	function ensure() {
		...
		try {
			var core = _shim;
			var langCpp = require("$:/plugins/tiddlywiki/codemirror-6-lang-cpp/lang-cpp.js");
			// Register C
	...
	core.registerLanguage(LanguageDescription.of({
		...
		load: function() {
			...
			return Promise.resolve(_desc["C"] ? _desc["C"].support : null);
		}
	}));
	core.registerLanguage(LanguageDescription.of({
		name: "C++",
