/*\
title: $:/plugins/tiddlywiki/markdown-to-tid/markdown/convert-markdown-on-import.js
...
exports.startup = function() {
	$tw.hooks.addHook("th-importing-tiddler", function(tiddler) {
		const shouldConvert = $tw.wiki.getTiddlerText("$:/config/markdown-to-tid/convert-markdown-on-import") === "yes";
		if(!shouldConvert) {
			return tiddler;
		}
