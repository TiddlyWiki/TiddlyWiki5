/*\
title: $:/plugins/tiddlywiki/markdown-to-tid/message-convert-markdown.js
	...
	$tw.rootWidget.addEventListener("tm-convert-markdown",function(event) {
		...
		try {
			...
			$tw.rootWidget.dispatchEvent({
				type: "tm-notify",
				param: "$:/plugins/tiddlywiki/markdown-to-tid/language/en-GB/Notifications/ConvertSuccess",
			...
			$tw.rootWidget.dispatchEvent({
				type: "tm-notify",
				param: "$:/plugins/tiddlywiki/markdown-to-tid/language/en-GB/Notifications/ConvertFailure",
				targetTiddler: tiddlerTitle
			});
		}
	});
