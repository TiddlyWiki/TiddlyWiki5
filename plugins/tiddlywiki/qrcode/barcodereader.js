...
BarCodeReaderWidget.prototype.render = function (parent, nextSibling) {
	...
	if ($tw.browser) {
		var __Html5QrcodeLibrary__ =
			require("$:/plugins/tiddlywiki/qrcode/html5-qrcode/html5-qrcode.js").__Html5QrcodeLibrary__;
		function onScanSuccess(decodedText, decodedResult) {
			self.invokeActionString(
				self.getAttribute("actionsSuccess", ""),
				self,
				{},
				{
		...
		function onScanFailure(errorMessage) {
			self.invokeActionString(
				self.getAttribute("actionsFailure", ""),
				self,
				{},
				{
					error: errorMessage
		...
		var html5QrcodeScanner = new __Html5QrcodeLibrary__.Html5QrcodeScanner(id, {
			fps: 10,
			qrbox: 250
		});
