/*\
title: $:/plugins/tiddlywiki/codemirror-6-lang-wast/register.js
...
exports.register = function() {
	...
	*/
	...
	function ensure() {
		...
		try {
			var core = _shim;
			var langWast = require("$:/plugins/tiddlywiki/codemirror-6-lang-wast/lang-wast.js");
	...
	core.registerLanguage(LanguageDescription.of({
		...
		load: function() {
			...
			return Promise.resolve(_desc["WebAssembly"] ? _desc["WebAssembly"].support : null);
		}
	}));
};
