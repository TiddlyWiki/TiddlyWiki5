"use strict";
var e = require("$:/plugins/tiddlywiki/codemirror-6/lib/codemirror-state.js"),
	t = require("$:/plugins/tiddlywiki/codemirror-6/lib/codemirror-language.js"),
	n = require("$:/plugins/tiddlywiki/codemirror-6/lib/codemirror-view.js"),
	r = require("$:/plugins/tiddlywiki/codemirror-6/lib/codemirror-search.js"),
	o = require("$:/plugins/tiddlywiki/codemirror-6/lib/codemirror-commands.js");
...
function s(e) {
	...
	function l(e) {
		...
		return t.onPasteFn || (t.onPasteFn = function() {
			t.insertMode || (e.setCursor(se(e.getCursor(), 0, 1)), oe.enterInsertMode(e, {}, t))
		}), t.onPasteFn
	}
	var c = /[\d]/,
	...
	function L(e, t, n, r, o) {
		...
		if(n || (n = "string"), M[e] = {
			...
			for(var i = 0; i < r.length; i++) M[r[i]] = M[e];
		t && b(e, t)
	}
	...
	L("filetype", void 0, "string", ["ft"], function(e, t) {
		if(void 0 !== t) {
			if(void 0 === e) {
	...
	}), L("textwidth", 80, "number", ["tw"], function(e, t) {
		if(void 0 !== t) {
			...
			function i(i, a) {
				...
				if(s && !s.find()) {
					var l, c = a > 0 ? 1 : -1,
						u = i.getCursor();
					do {
						if((s = o[(e + (t += c)) % e]) && (l = s.find()) && !he(u, l)) break
					} while(t < n && t > r)
				}
				return s
			}
	...
	class B {
		constructor() {
			this.latestRegister = void 0, this.isPlaying = !1, this.isRecording = !1, this.replaySearchQueries = [], this.onRecordingDone = void 0, this.lastInsertModeChanges = R()
		}
		exitMacroRecordMode() {
		...
		enterMacroRecordMode(e, t) {
			var n = E.registerController.getRegister(t);
			if(n) {
				if(n.clear(), this.latestRegister = t, e.openDialog) {
					var r = qe("span", {
						class: "cm-vim-message"
					}, "recording @" + t);
					this.onRecordingDone = e.openDialog(r, function() {}, {
						bottom: !0
					})
				}
				this.isRecording = !0
	...
	var D, P = {
			enterVimMode: function(t) {
				t.setOption("disableInput", !0), t.setOption("showCursorWhenSelecting", !1), e.signal(t, "vim-mode-change", {
					mode: "normal"
				}), t.on("cursorActivity", ht), N(t), e.on(t.getInputField(), "paste", l(t))
			},
			leaveVimMode: function(t) {
				t.setOption("disableInput", !1), t.off("cursorActivity", ht), e.off(t.getInputField(), "paste", l(t)), t.state.vim = null, Xe && clearTimeout(Xe)
			},
			buildKeyMap: function() {},
			getRegisterController: function() {
				return E.registerController
			},
			resetVimGlobalState_: I,
			getVimGlobalState_: function() {
				return E
			},
			maybeInitVimState_: N,
			...
			multiSelectHandleKey: function(e, t, n) {
				var r = N(e),
					o = e,
					i = !1,
					a = (r = P.maybeInitVimState_(o), r.visualBlock || r.wasInVisualBlock);
				if(o.state.closeVimNotification) {
					var s = o.state.closeVimNotification;
					if(o.state.closeVimNotification = null, s(), "<CR>" == t) return J(o), !0
				}
				var l = o.isInMultiSelectMode();
				r.wasInVisualBlock && !l ? r.wasInVisualBlock = !1 : l && r.visualBlock && (r.wasInVisualBlock = !0);
				if("<Esc>" != t || r.insertMode || r.visualMode || !l || "<Esc>" != r.status)
					if(a || !l || o.inVirtualSelectionMode) i = P.handleKey(o, t, n);
					else {
						var c = vt(r),
							u = r.inputState.changeQueueList || [];
						o.operation(function() {
							o.curOp && (o.curOp.isVimOp = !0);
							var e = 0;
							o.forEachSelection(function() {
								o.state.vim.inputState.changeQueue = u[e];
								var r = o.getCursor("head"),
									a = o.getCursor("anchor"),
									s = de(r, a) ? 0 : -1,
									l = de(r, a) ? -1 : 0;
								r = se(r, 0, s), a = se(a, 0, l), o.state.vim.sel.head = r, o.state.vim.sel.anchor = a, i = P.handleKey(o, t, n), o.virtualSelection && (u[e] = o.state.vim.inputState.changeQueue, o.state.vim = vt(c)), e++
							}), o.curOp?.cursorActivity && !i && (o.curOp.cursorActivity = !1), o.state.vim = r, r.inputState.changeQueueList = u, r.inputState.changeQueue = null
						}, !0)
					}
				else J(o);
				!i || r.visualMode || r.insertMode || r.visualMode == o.somethingSelected() || dt(o, r);
				return i
			},
			findKey: function(t, n, o) {
				var i = N(t),
					a = t;
				...
				function s() {
					var e = E.macroModeState;
					if(e.isRecording) {
						if("q" == n) return e.exitMacroRecordMode(), J(a), !0;
						"mapping" != o && function(e, t) {
							if(e.isPlaying) return;
							var n = e.latestRegister,
								r = E.registerController.getRegister(n);
							r && r.pushText(t)
						}(e, n)
					}
				}
				...
				var c = i.insertMode ? function() {
					if(l()) return !0;
					i.inputState.keyBuffer.push(n);
					var e = i.inputState.keyBuffer.join(""),
						t = 1 == n.length,
						o = ee.matchCommand(e, r, i.inputState, "insert"),
						s = i.inputState.changeQueue;
					if("none" == o.type) return J(a), !1;
					if("partial" == o.type) {
						if(o.expectLiteralNext && (i.expectLiteralNext = !0), O && window.clearTimeout(O), O = t && window.setTimeout(function() {
								i.insertMode && i.inputState.keyBuffer.length && J(a)
							}, A("insertModeEscKeysTimeout")), t) {
							var c = a.listSelections();
							s && s.removed.length == c.length || (s = i.inputState.changeQueue = new X), s.inserted += n;
							for(var u = 0; u < c.length; u++) {
								var h = me(c[u].anchor, c[u].head),
									d = pe(c[u].anchor, c[u].head),
									m = a.getRange(h, a.state.overwrite ? se(d, 0, 1) : d);
								s.removed[u] = (s.removed[u] || "") + m
							}
						}
						return !t
					}
					if("full" == o.type && (i.inputState.keyBuffer.length = 0), i.expectLiteralNext = !1, O && window.clearTimeout(O), o.command && s) {
						for(c = a.listSelections(), u = 0; u < c.length; u++) {
							var p = c[u].head;
							a.replaceRange(s.removed[u] || "", se(p, 0, -s.inserted.length), p, "+input")
						}
						E.macroModeState.lastInsertModeChanges.changes.pop()
					}
					return o.command || J(a), o.command
				}() : function() {
					if(s() || l()) return !0;
					i.inputState.keyBuffer.push(n);
					var e = i.inputState.keyBuffer.join("");
					...
					var u = ee.matchCommand(c, r, i.inputState, o);
					return "none" == u.type ? (J(a), !1) : "partial" == u.type ? (u.expectLiteralNext && (i.expectLiteralNext = !0), !0) : "clear" == u.type ? (J(a), !0) : (i.expectLiteralNext = !1, i.inputState.keyBuffer.length = 0, (t = /^(\d*)(.*)$/.exec(e)) && t[1] && "0" != t[1] && i.inputState.pushRepeatDigit(t[1]), u.command)
				}();
				return !1 === c ? !i.insertMode && (1 === n.length || e.isMac && /<A-.>/.test(n)) ? function() {
					return !0
				} : void 0 : !0 === c ? function() {
					return !0
				} : c ? function() {
					return a.operation(function() {
						...
						try {
							...
							"keyToKey" == c.type ? j(a, c.toKeys, c) : ee.processCommand(a, i, c)
						} catch (e) {
							throw a.state.vim = void 0, N(a), P.suppressErrorLogging || console.log(e), e
						}
						return !0
					})
				} : void 0
			...
			defineRegister: function(e, t) {
				var n = E.registerController.registers;
	...
	function V(e) {
		if(!D) throw new Error("No prompt to send key to");
		if("<" == e[0]) {
			...
			if("lt" == (t = n.pop() || "")) e = "<";
				...
				return D.onKeyDown && D.onKeyDown(o, D.value, a), void(D && D.onKeyUp && D.onKeyUp(o, D.value, a))
			}
		}
		if("\n" == e) {
			var i = D;
			D = null, i.onClose && i.onClose(i.value)
		} else D.value = (D.value || "") + e;

		function a(e) {
			D && ("string" == typeof e ? D.value = e : D = null)
		}
	}
	...
	function j(e, t, n) {
		var r = F;
		if(n) {
			if(-1 != H.indexOf(n)) return;
			H.push(n), F = 0 != n.noremap
		}
		try {
			for(var o, i = N(e), a = /<(?:[CSMA]-)*\w+>|./gi; o = a.exec(t);) {
				var s = o[0],
					l = i.insertMode;
				if(D) V(s);
				else if(!P.handleKey(e, s, "mapping") && l && i.insertMode) {
					if("<" == s[0]) {
			...
			if(H.pop(), F = !!H.length && r, !H.length && D) {
				var h = D;
				D = null, ze(e, h)
			}
		}
	...
	function U(t, n) {
		var r = t.key;
		if(!_[r]) {
			r.length > 1 && "n" == r[0] && (r = r.replace("Numpad", "")), r = $[r] || r;
			var i = "";
			if(t.ctrlKey && (i += "C-"), t.altKey && (i += "A-"), t.metaKey && (i += "M-"), e.isMac && "A-" == i && 1 == r.length && (i = i.slice(2)), (i || r.length > 1) && t.shiftKey && (i += "S-"), n && !n.expectLiteralNext && 1 == r.length)
				if(s.keymap && r in s.keymap) 0 == s.remapCtrl && i || (r = s.keymap[r]);
				else if(r.charCodeAt(0) > 128 && !o[r]) {
				var a = t.code?.slice(-1) || "";
				t.shiftKey || (a = a.toLowerCase()), a && (r = a, !i && t.altKey && (i = "A-"))
			}
			return (i += r).length > 1 && (i = "<" + i + ">"), i
		}
	}

	function q(e, t) {
		s.string !== e && (s = Q(e)), s.remapCtrl = t
	}
	...
	"Left|Right|Up|Down|End|Home".split("|").concat(Object.keys($)).forEach(function(e) {
		W[($[e] || "").toLowerCase()] = W[e.toLowerCase()] = e
	}), L("langmap", void 0, "string", ["lmap"], function(e, t) {
		if(void 0 === e) return s.string;
		q(e)
	});
	class z {
		constructor() {
	...
	function J(t, n) {
		t.state.vim.inputState = new z, t.state.vim.expectLiteralNext = !1, e.signal(t, "vim-command-done", n)
	}
	...
	class Y {
		constructor(e) {
			this.registers = e, this.unnamedRegister = e['"'] = new G, e["."] = new G, e[":"] = new G, e["/"] = new G, e["+"] = new G
		}
		pushText(e, t, n, r, o) {
			if("_" !== e) {
				...
				if(i && e) {
					w(e) ? i.pushText(n, r) : i.setText(n, r, o), "+" === e && navigator.clipboard.writeText(n), this.unnamedRegister.setText(i.toString(), r)
				} else {
					switch(t) {
						case "yank":
							this.registers[0] = new G(n, r, o);
							break;
						case "delete":
						case "change":
							-1 == n.indexOf("\n") ? this.registers["-"] = new G(n, r) : (this.shiftNumericRegisters_(), this.registers[1] = new G(n, r))
					}
		...
		getRegister(e) {
			return this.isValidRegister(e) ? (e = e.toLowerCase(), this.registers[e] || (this.registers[e] = new G), this.registers[e]) : this.unnamedRegister
		}
		isValidRegister(e) {
			return e && (x(e, m) || p.test(e))
		}
	...
	var ee = {
			matchCommand: function(e, t, n, r) {
				var o = function(e, t, n, r) {
						...
						for(var o, a = [], s = [], l = F ? t.length - i : 0; l < t.length; l++) {
							var c = t[l];
							"insert" == n && "insert" != c.context || c.context && c.context != n || r.operator && "action" == c.type || !(o = le(e, c.keys)) || ("partial" == o && a.push(c), "full" == o && s.push(c))
						}
						return {
							partial: a,
							full: s
					...
					a = o.full[0];
				if(!a) return o.partial.length ? {
					type: "partial",
					expectLiteralNext: 1 == o.partial.length && "<character>" == o.partial[0].keys.slice(-11)
				} : {
					type: "none"
				};
				if("<character>" == a.keys.slice(-11) || "<register>" == a.keys.slice(-10)) {
					var s = function(e) {
						var t = /^.*(<[^>]+>)$/.exec(e),
							n = t ? t[1] : e.slice(-1);
			...
			processOperator: function(e, t, n) {
				...
				r.operator = n.operator, r.operatorArgs = ae(n.operatorArgs), n.keys.length > 1 && (r.operatorShortcut = n.keys), n.exitVisualBlock && (t.visualBlock = !1, Se(e)), t.visualMode && this.evalInput(e, t)
			},
			processOperatorMotion: function(e, t, n) {
				var r = t.visualMode,
					o = ae(n.operatorMotionArgs);
			...
			processAction: function(e, t, n) {
				...
				r.selectedCharacter && (a.selectedCharacter = r.selectedCharacter), n.operator && this.processOperator(e, t, n), n.motion && this.processMotion(e, t, n), (n.motion || n.operator) && this.evalInput(e, t), a.repeat = o || 1, a.repeatIsExplicit = i, a.registerName = r.registerName, J(e), t.lastMotion = null, n.isEdit && this.recordLastEdit(t, r, n), oe[n.action](e, a, t)
			},
			processSearch: function(t, n, r) {
				if(t.getSearchCursor) {
					...
					switch(r.searchArgs.querySrc) {
						case "prompt":
							var u = E.macroModeState;
							if(u.isPlaying) {
								m(u.replaySearchQueries.shift() || "", !0, !1)
							} else ze(t, {
								onClose: function(e) {
									t.scrollTo(l.left, l.top), m(e, !0, !0);
								...
								desc: qe("span", {
									...
									onmousedown: function(e) {
										e.preventDefault(), b("pcre", !A("pcre")), this.textContent = p(), f()
									}
								}, p()),
								onKeyUp: function(e, t, n) {
									var r, o, i = U(e);
									"<Up>" == i || "<Down>" == i ? (r = "<Up>" == i, o = e.target ? e.target.selectionEnd : 0, n(t = E.searchHistoryController.nextMatch(t, r) || ""), o && e.target && (e.target.selectionEnd = e.target.selectionStart = Math.min(o, e.target.value.length))) : i && "<Left>" != i && "<Right>" != i && E.searchHistoryController.reset(), c = t, f()
								},
								onKeyDown: function(n, r, o) {
									var i = U(n);
									"<Esc>" == i || "<C-c>" == i || "<C-[>" == i || "<BS>" == i && "" == r ? (E.searchHistoryController.pushInput(r), E.searchHistoryController.reset(), Je(t, s?.source || ""), Ze(t), t.scrollTo(l.left, l.top), e.e_stop(n), J(t), o(), t.focus()) : "<Up>" == i || "<Down>" == i ? e.e_stop(n) : "<C-u>" == i && (e.e_stop(n), o(""))
								}
							});
							break;
						case "wordUnderCursor":
							...
							if(h || (h = be(t, {
									noSymbol: !1
								}), d = !1), !h) return Qe(t, "No word under cursor"), void J(t);
							let n = t.getLine(h.start.line).substring(h.start.ch, h.end.ch);
							n = d && i ? "\\b" + n + "\\b" : n.replace(/([.?*+$\[\]\/\\(){}|\-])/g, "\\$1"), E.jumpList.cachedCursor = t.getCursor(), t.setCursor(h.start), m(n, !0, !1)
					}
				}

				function m(e, o, i) {
					E.searchHistoryController.pushInput(e), E.searchHistoryController.reset();
					try {
						Je(t, e, o, i)
					} catch (n) {
						return Qe(t, "Invalid regex: " + e), void J(t)
					}
					ee.processMotion(t, n, {
						keys: "",
						type: "motion",
						motion: "findNext",
						motionArgs: {
				...
				function p() {
					return A("pcre") ? "(JavaScript regexp: set pcre)" : "(Vim regexp: set nopcre)"
				}
				...
				function f() {
					...
					e ? t.scrollIntoView(Ye(t, !o, e), 30) : (Ze(t), t.scrollTo(l.left, l.top))
				}
			},
			processEx: function(t, n, r) {
				if("keyToEx" == r.type) it.processCommand(t, r.exArgs.input);
				else {
					var o = {
						onClose: function(e) {
							E.exCommandHistoryController.pushInput(e), E.exCommandHistoryController.reset(), it.processCommand(t, e), t.state.vim && J(t), Ze(t)
						},
						onKeyDown: function(n, r, o) {
							var i, a, s = U(n);
							("<Esc>" == s || "<C-c>" == s || "<C-[>" == s || "<BS>" == s && "" == r) && (E.exCommandHistoryController.pushInput(r), E.exCommandHistoryController.reset(), e.e_stop(n), J(t), Ze(t), o(), t.focus()), "<Up>" == s || "<Down>" == s ? (e.e_stop(n), i = "<Up>" == s, a = n.target ? n.target.selectionEnd : 0, o(r = E.exCommandHistoryController.nextMatch(r, i) || ""), a && n.target && (n.target.selectionEnd = n.target.selectionStart = Math.min(a, n.target.value.length))) : "<C-u>" == s ? (e.e_stop(n), o("")) : s && "<Left>" != s && "<Right>" != s && E.exCommandHistoryController.reset()
						},
						onKeyUp: function(n, r) {
							var o = new e.StringStream(r),
								i = {};
							try {
								if(it.parseInput_(t, o, i), "s" != i.commandName) return void Ze(t);
								var a = it.matchCommand_(i.commandName);
								if(!a) return;
								if(it.parseCommandArgs_(o, i, a), !i.argString) return;
								var s = Ue(i.argString.slice(1), !0, !0);
								s && Ge(t, s)
							} catch (n) {}
						},
						prefix: ":"
					};
					n.visualMode && (o.value = "'<,'>", o.selectValueOnOpen = !1), ze(t, o)
				}
			},
			evalInput: function(e, r) {
				var o, i, a, s = r.inputState,
					...
					d = s.registerName,
					m = r.sel,
					p = ue(r.visualMode ? ie(e, m.head) : e.getCursor("head")),
					f = ue(r.visualMode ? ie(e, m.anchor) : e.getCursor("anchor")),
					g = ue(p),
					v = ue(f);
				if(u && this.recordLastEdit(r, s), (a = void 0 !== s.repeatOverride ? s.repeatOverride : s.getRepeat()) > 0 && c.explicitRepeat ? c.repeatIsExplicit = !0 : (c.noRepeat || !c.explicitRepeat && 0 === a) && (a = 1, c.repeatIsExplicit = !1), s.selectedCharacter && (c.selectedCharacter = h.selectedCharacter = s.selectedCharacter), c.repeat = a, J(e), l) {
					var y = te[l](e, p, c, r, s);
					if(r.lastMotion = te[l], !y) return;
					if(c.toJumplist) {
						var C = E.jumpList,
							w = C.cachedCursor;
						w ? (Ae(e, w, y), delete C.cachedCursor) : Ae(e, p, y)
					}
					y instanceof Array ? (i = y[0], o = y[1]) : o = y, o || (o = ue(p)), r.visualMode ? (r.visualBlock && o.ch === 1 / 0 || (o = ie(e, o, g)), i && (i = ie(e, i)), i = i || v, m.anchor = i, m.head = o, Se(e), Ie(e, r, "<", de(i, o) ? i : o), Ie(e, r, ">", de(i, o) ? o : i)) : u || (o = ie(e, o, g), e.setCursor(o.line, o.ch))
				}
				if(u) {
					if(h.lastSel) {
						i = v;
						var S = h.lastSel,
							x = Math.abs(S.head.line - S.anchor.line),
							M = Math.abs(S.head.ch - S.anchor.ch);
						o = S.visualLine ? new t(v.line + x, v.ch) : S.visualBlock ? new t(v.line + x, v.ch + M) : S.head.line == S.anchor.line ? new t(v.line, v.ch + M) : new t(v.line + x, v.ch), r.visualMode = !0, r.visualLine = S.visualLine, r.visualBlock = S.visualBlock, m = r.sel = {
							anchor: i,
							head: o
						}, Se(e)
					...
					var L, b, A, O, T;
					if(r.visualMode) {
						if(L = me(m.head, m.anchor), b = pe(m.head, m.anchor), A = r.visualLine || h.linewise, O = r.visualBlock ? "block" : A ? "line" : "char", T = xe(e, {
								anchor: (I = n(e, L, b)).start,
								head: I.end
							}, O), A) {
							var R = T.ranges;
							if("block" == O)
								for(var B = 0; B < R.length; B++) R[B].head.ch = ge(e, R[B].head.line);
							else "line" == O && (R[0].head = new t(R[0].head.line + 1, 0))
						}
					} else {
						if(L = ue(i || v), de(b = ue(o || g), L)) {
							var N = L;
							L = b, b = N
						}(A = c.linewise || h.linewise) ? function(e, t, n) {
							t.ch = 0, n.ch = 0, n.line++
						}(0, L, b) : c.forward && function(e, t, n) {
							var r = e.getRange(t, n);
							if(/\n\s*$/.test(r)) {
								var o = r.split("\n");
								o.pop();
								for(var i = o.pop(); o.length > 0 && i && k(i); i = o.pop()) n.line--, n.ch = 0;
								i ? (n.line--, n.ch = ge(e, n.line)) : n.ch = 0
							}
						}(e, L, b), O = "char";
						var I, K = !c.inclusive || A;
						T = xe(e, {
							anchor: (I = n(e, L, b)).start,
							head: I.end
						}, O, K)
					}
					e.setSelections(T.ranges, T.primary), r.lastMotion = null, h.repeat = a, h.registerName = d, h.linewise = A;
					var D = re[u](e, h, T.ranges, v, o);
					r.visualMode && Me(e, null != D), D && e.setCursor(D)
				}
			},
		...
		te = {
			moveToTopLine: function(e, n, r) {
				var o = tt(e).top + r.repeat - 1;
				return new t(o, Le(e.getLine(o)))
			},
			moveToMiddleLine: function(e) {
				var n = tt(e),
					r = Math.floor(.5 * (n.top + n.bottom));
				return new t(r, Le(e.getLine(r)))
			},
			moveToBottomLine: function(e, n, r) {
				var o = tt(e).bottom - r.repeat + 1;
				return new t(o, Le(e.getLine(o)))
			},
			...
			findNext: function(e, t, n) {
				...
				if(o) {
					var i = !n.forward;
					i = r.isReversed() ? !i : i, Ge(e, o);
					var a = Ye(e, i, o, n.repeat);
					return a || Qe(e, "No match found " + o + (A("pcre") ? " (set nopcre to use Vim regexps)" : "")), a
				}
			},
						...
						u = function(e, n, r, o, i) {
							return e.operation(function() {
								...
								var a = e.getCursor(),
									...
									l = s.find(!n);
								!i.visualMode && l && he(s.from(), a) && s.find(!n);
								for(var c = 0; c < o; c++)
			...
			goToMark: function(e, t, n, r) {
				var o = nt(e, r, n.selectedCharacter || "");
				return o ? n.linewise ? {
					line: o.line,
					ch: Le(e.getLine(o.line))
				} : o : null
			},
			moveToOtherHighlightedEnd: function(e, n, r, o) {
				var i = o.sel;
				return o.visualBlock && r.sameLine ? [ie(e, new t(i.anchor.line, i.head.ch)), ie(e, new t(i.head.line, i.anchor.ch))] : [i.head, i.anchor]
			},
				...
				for(var i = n, a = 0; a < r.repeat; a++) {
					...
					for(var l in o.marks)
						if(v(l)) {
							...
							if(!((r.forward ? de(c, s) : de(s, c)) || r.linewise && c.line == s.line)) {
								var u = he(s, i),
									h = r.forward ? fe(s, c, i) : fe(i, c, s);
								(u || h) && (i = c)
							}
						}
				}
				return r.linewise && (i = new t(i.line, Le(e.getLine(i.line)))), i
			},
			...
			moveByLines: function(e, n, r, o) {
				...
				return (r.forward ? h.line > l : h.line < l) && (l = h.line, a = h.ch), l < c && i.line == c ? this.moveToStartOfLine(e, n, r, o) : l > u && i.line == u ? Be(e, n, r, o, !0) : (r.toFirstChar && (a = Le(e.getLine(l)), o.lastHPos = a), o.lastHSPos = e.charCoords(new t(l, a), "div").left, new t(l, a))
			},
			...
			moveByParagraph: function(e, t, n) {
				var r = n.forward ? 1 : -1;
				return De(e, t, n.repeat, r).start
			},
				...
				return function(e, n, r, o) {
					function i(e, t) {
						if(null !== t.line)
							if(t.pos + t.dir < 0 || t.pos + t.dir >= t.line.length) {
								if(t.ln += t.dir, !g(e, t.ln)) return void(t.line = null);
					...
					function a(e, t, n, r) {
						...
						for(i(e, a); null !== a.line;) {
							...
							if(o && "" !== a.line && !k(a.line[a.pos])) return {
								ln: a.ln,
								pos: a.pos
							};
							!S(a.line[a.pos]) || o || a.pos !== a.line.length - 1 && !k(a.line[a.pos + 1]) || (o = !0), i(e, a)
						}
					...
					function s(e, t, n, r) {
						...
						for(i(e, o); null !== o.line;) {
							...
							if(S(o.line[o.pos]) && null !== s && (o.ln !== a || o.pos + 1 !== s)) return {
								ln: a,
								pos: s
							};
							"" === o.line || k(o.line[o.pos]) || (l = !1, a = o.ln, s = o.pos), i(e, o)
						}
						var c = e.getLine(a);
						s = 0;
						for(var u = 0; u < c.length; ++u)
			...
			moveByScroll: function(e, t, n, r) {
				...
				if(n.repeat = a, !(o = te.moveByDisplayLines(e, t, n, r))) return null;
			...
			moveTillCharacter: function(e, t, n) {
				var r = Ne(e, n.repeat, n.forward, n.selectedCharacter, t),
					o = n.forward ? -1 : 1;
				return Ee(o, n), r ? (r.ch += o, r) : null
			},
			moveToCharacter: function(e, t, n) {
				var r = n.repeat;
				return Ee(0, n), Ne(e, r, n.forward, n.selectedCharacter, t) || t
			},
			moveToSymbol: function(e, n, r) {
				var o = r.repeat;
				return r.selectedCharacter && function(e, n, r, o) {
					var i = ue(e.getCursor()),
						a = r ? 1 : -1,
						s = r ? e.lineCount() : -1,
						l = i.ch,
						c = i.line,
			...
			moveToFirstNonWhiteSpaceCharacter: function(e, n) {
				var r = n;
				return new t(r.line, Le(e.getLine(r.line)))
			},
			...
			moveToLineOrEdgeOfDocument: function(e, n, r) {
				...
				return r.repeatIsExplicit && (o = r.repeat - e.getOption("firstLineNumber")), new t(o, Le(e.getLine(o)))
			},
			...
			textObjectManipulation: function(n, r, o, i) {
				...
				if({
					...
					var i, a, s, l, c = ue(n),
						...
						d = h.indexOf(r);
					if(c.ch < d) c.ch = d;
					else if(d < c.ch && h[c.ch] == r) {
						var m = /string/.test(e.getTokenTypeAt(se(n, 0, 1))),
							p = /string/.test(e.getTokenTypeAt(n));
						m && !p || (a = c.ch, --c.ch)
					}
					if(h[c.ch] != r || a)
						for(s = c.ch; s > -1 && !i; s--) h[s] == r && (i = s + 1);
					else i = c.ch + 1;
					if(i && !a)
						for(s = i, l = h.length; s < l && !a; s++) h[s] == r && (a = s);
					if(!i || !a) return {
						start: c,
						end: c
					};
					...
					for(var h = o.repeat || 1; h-- > 0;) {
						...
						if(s = De(n, r, o.repeat, 0, c), o.linewise = !0, i.visualMode) i.visualLine || (i.visualLine = !0);
						else {
					...
					r.ch > 0 && S(p[r.ch]) && (r.ch -= 1);
					var f = Pe(n, r, o.repeat, 1, c),
						g = Pe(n, r, o.repeat, -1, c);
					k(n.getLine(g.line)[g.ch]) && k(n.getLine(f.line)[f.ch - 1]) && (g = {
						line: g.line,
						ch: g.ch + 1
					}), s = {
						start: g,
				...
				return s ? n.state.vim.visualMode ? function(e, n, r, o) {
					var i, a = e.state.vim.sel,
						...
						l = o ? n : a.anchor;
					de(r, n) && (i = r, r = n, n = i);
					de(s, l) ? (s = me(n, s), l = pe(l, r)) : (l = me(n, l), -1 == (s = se(s = pe(s, r), 0, -1)).ch && s.line != e.firstLine() && (s = new t(s.line - 1, ge(e, s.line - 1))));
					return [l, s]
				}(n, s.start, s.end, l) : [s.start, s.end] : null
			},
			repeatLastCharacterSearch: function(e, t, n) {
				var r = E.lastCharacterSearch,
					o = n.repeat,
					i = n.forward === r.forward,
					a = (r.increment ? 1 : 0) * (i ? -1 : 1);
				e.moveH(-a, "char"), n.inclusive = !!i;
				var s = Ne(e, o, i, r.selectedCharacter);
	...
	var re = {
		change: function(e, n, r) {
			...
			if(a.visualMode)
				if(n.fullLine) l.ch = Number.MAX_VALUE, l.line--, e.setSelection(s, l), i = e.getSelection(), e.replaceSelection(""), o = s;
					...
					i = e.getSelection();
					var c = ne("", r.length);
					e.replaceSelections(c), o = me(r[0].head, r[0].anchor)
				}
			else {
				i = e.getRange(s, l);
				var u = a.lastEditInputState;
				if("moveByWords" == u?.motion && !k(i)) {
					var h = /\s+$/.exec(i);
					h && u.motionArgs && u.motionArgs.forward && (l = se(l, 0, -h[0].length), i = i.slice(0, -h[0].length))
				}
				n.linewise && (s = new t(s.line, Le(e.getLine(s.line))), l.line > s.line && (l = new t(l.line - 1, Number.MAX_VALUE))), e.replaceRange("", s, l), o = s
			}
			E.registerController.pushText(n.registerName, "change", i, n.linewise, r.length > 1), oe.enterInsertMode(e, {
				head: o
			}, e.state.vim)
		},
		delete: function(e, n, r) {
			...
			if(a.visualBlock) {
				i = e.getSelection();
				var s = ne("", r.length);
				e.replaceSelections(s), o = me(r[0].head, r[0].anchor)
			} else {
				var l = r[0].anchor,
					c = r[0].head;
				n.linewise && c.line != e.firstLine() && l.line == e.lastLine() && l.line == c.line - 1 && (l.line == e.firstLine() ? l.ch = 0 : l = new t(l.line - 1, ge(e, l.line - 1))), i = e.getRange(l, c), e.replaceRange("", l, c), o = l, n.linewise && (o = te.moveToFirstNonWhiteSpaceCharacter(e, l))
			}
			return E.registerController.pushText(n.registerName, "delete", i, n.linewise, a.visualBlock), ie(e, o)
		},
		indent: function(e, t, n) {
			var r = e.state.vim,
				o = r.visualMode && t.repeat || 1;
			if(r.visualBlock) {
				for(var i, a = e.getOption("tabSize"), s = e.getOption("indentWithTabs") ? "\t" : " ".repeat(a), l = n.length - 1; l >= 0; l--)
					if(i = me(n[l].anchor, n[l].head), t.indentRight) e.replaceRange(s.repeat(o), i, i);
					else {
						for(var c = e.getLine(i.line), u = 0, h = 0; h < o; h++) {
							var d = c[i.ch + u];
							if("\t" == d) u++;
							else {
								if(" " != d) break;
								u++;
								for(var m = 1; m < s.length && " " === (d = c[i.ch + u]); m++) u++
							}
						}
						e.replaceRange("", i, se(i, 0, u))
					} return i
			}
			if(e.indentMore)
				for(h = 0; h < o; h++) t.indentRight ? e.indentMore() : e.indentLess();
			else {
				var p = n[0].anchor.line,
					f = r.visualBlock ? n[n.length - 1].anchor.line : n[0].head.line;
				t.linewise && f--;
				for(l = p; l <= f; l++)
					for(h = 0; h < o; h++) e.indentLine(l, t.indentRight)
			}
			return te.moveToFirstNonWhiteSpaceCharacter(e, n[0].anchor)
		},
		indentAuto: function(e, t, n) {
			return e.execCommand("indentAuto"), te.moveToFirstNonWhiteSpaceCharacter(e, n[0].anchor)
		},
		...
		changeCase: function(e, t, n, r, o) {
			...
			return e.replaceSelections(a), t.shouldMoveCursor ? o : !e.state.vim.visualMode && t.linewise && n[0].anchor.line + 1 == n[0].head.line ? te.moveToFirstNonWhiteSpaceCharacter(e, r) : t.linewise ? r : me(n[0].anchor, n[0].head)
		},
		yank: function(e, t, n, r) {
			var o = e.state.vim,
				i = e.getSelection(),
				a = o.visualMode ? me(o.sel.anchor, o.sel.head, n[0].head, n[0].anchor) : r;
			return E.registerController.pushText(t.registerName, "yank", i, t.linewise, o.visualBlock), a
		},
		rot13: function(e, t, n, r, o) {
			for(var i = e.getSelections(), a = [], s = 0; s < i.length; s++) {
				const e = i[s].split("").map(e => {
	...
	var oe = {
		...
		replayMacro: function(e, t, n) {
			var r = t.selectedCharacter || "",
				o = t.repeat || 1,
				i = E.macroModeState;
			for("@" == r ? r = i.latestRegister || "" : i.latestRegister = r; o--;) ct(e, n, i, r)
		},
		enterMacroRecordMode: function(e, t) {
			var n = E.macroModeState,
				r = t.selectedCharacter;
			E.registerController.isValidRegister(r) && n.enterMacroRecordMode(e, r)
		},
		...
		enterInsertMode: function(r, o, i) {
			if(!r.getOption("readOnly")) {
				...
				if("eol" == a) l = new t(l.line, ge(r, l.line));
				else if("bol" == a) l = new t(l.line, 0);
				else if("charAfter" == a) {
					l = n(r, l, se(l, 0, 1)).end
				} else if("firstNonBlank" == a) {
					l = n(r, l, te.moveToFirstNonWhiteSpaceCharacter(r, l)).end
					...
					if(!i.visualMode) return;
					i.visualBlock ? (l = new t(Math.min(s.head.line, s.anchor.line), Math.max(s.head.ch, s.anchor.ch) + 1), c = Math.abs(s.head.line - s.anchor.line) + 1) : l = s.head.line >= s.anchor.line ? se(s.head, 0, 1) : new t(s.anchor.line, 0)
				} else if("inplace" == a) {
					if(i.visualMode) return
				} else "lastEdit" == a && (l = rt(r) || l);
				r.setOption("disableInput", !1), o && o.replace ? (r.toggleOverwrite(!0), r.setOption("keyMap", "vim-replace"), e.signal(r, "vim-mode-change", {
					...
					mode: "insert"
				})), E.macroModeState.isPlaying || (r.on("change", ut), i.insertEnd && i.insertEnd.clear(), i.insertEnd = r.setBookmark(l, {
					insertLeft: !0
				}), e.on(r.getInputField(), "keydown", mt)), i.visualMode && Me(r), we(r, l, c)
			}
		},
		toggleVisualMode: function(r, o, i) {
			...
			if(i.visualMode) i.visualLine != !!o.linewise || i.visualBlock != !!o.blockwise ? (i.visualLine = !!o.linewise, i.visualBlock = !!o.blockwise, e.signal(r, "vim-mode-change", {
				...
				var c = n(r, l, a = ie(r, new t(l.line, l.ch + s - 1)));
				i.sel = {
					anchor: c.start,
					head: c.end
		...
		reselectLastSelection: function(t, n, r) {
			...
			if(r.visualMode && ke(t, r), o) {
				...
				r.sel = {
					anchor: i,
					head: a
				}, r.visualMode = !0, r.visualLine = o.visualLine, r.visualBlock = o.visualBlock, Se(t), Ie(t, r, "<", me(i, a)), Ie(t, r, ">", pe(i, a)), e.signal(t, "vim-mode-change", {
					mode: "visual",
		...
		joinLines: function(e, n, r) {
			var o, i;
			if(r.visualMode) {
				if(o = e.getCursor("anchor"), de(i = e.getCursor("head"), o)) {
					var a = i;
					i = o, o = a
				}
				i.ch = ge(e, i.line) - 1
				...
				o = e.getCursor(), i = ie(e, new t(o.line + s - 1, 1 / 0))
			}
			...
			var m = ie(e, new t(o.line, l));
			r.visualMode && Me(e, !1), e.setCursor(m)
		},
		newLineAndEnterInsertMode: function(n, r, o) {
			o.insertMode = !0;
			var i = ue(n.getCursor());
			i.line !== n.firstLine() || r.after ? (i.line = r.after ? i.line : i.line - 1, i.ch = ge(n, i.line), n.setCursor(i), (e.commands.newlineAndIndentContinueComment || e.commands.newlineAndIndent)(n)) : (n.replaceRange("\n", new t(n.firstLine(), 0)), n.setCursor(n.firstLine(), 0));
			this.enterInsertMode(n, {
				repeat: r.repeat
			}, o)
		},
		paste: function(e, t, n) {
			var r = E.registerController.getRegister(t.registerName);
		...
		continuePaste: function(e, n, r, o, i) {
			...
			if(o) {
				...
				n.repeat > 1 && (o = Array(n.repeat + 1).join(o));
				var p, f = i.linewise,
					g = i.blockwise,
					v = g ? o.split("\n") : void 0;
				if(v) {
					f && v.pop();
					for(var y = 0; y < v.length; y++) v[y] = "" == v[y] ? " " : v[y];
					a.ch += n.after ? 1 : 0, a.ch = Math.min(ge(e, a.line), a.ch)
				} else f ? r.visualMode ? o = r.visualLine ? o.slice(0, -1) : "\n" + o.slice(0, o.length - 1) + "\n" : n.after ? (o = "\n" + o.slice(0, o.length - 1), a.ch = ge(e, a.line)) : a.ch = 0 : a.ch += n.after ? 1 : 0;
				if(r.visualMode) {
					var C;
					r.lastPastedText = o;
					var w = function(e) {
							var t = e.listSelections(),
								n = t[0],
								r = t[t.length - 1],
								o = de(n.anchor, n.head) ? n.anchor : n.head,
								i = de(r.anchor, r.head) ? r.head : r.anchor;
							return [o, i]
						}(e),
						k = w[0],
						S = w[1],
						x = e.getSelection(),
						M = e.listSelections(),
						L = new Array(M.length).join("1").split("1");
					r.lastSelection && (C = r.lastSelection.headMark.find()), E.registerController.unnamedRegister.setText(x), g ? (e.replaceSelections(L), S = new t(k.line + o.length - 1, k.ch), e.setCursor(k), Ce(e, S), e.replaceSelections(o), p = k) : r.visualBlock ? (e.replaceSelections(L), e.setCursor(k), e.replaceRange(o, k, k), p = k) : (e.replaceRange(o, k, S), p = e.posFromIndex(e.indexFromPos(k) + o.length - 1)), C && (r.lastSelection.headMark = e.setBookmark(C)), f && (p.ch = 0)
				} else if(g && v) {
					e.setCursor(a);
					for(y = 0; y < v.length; y++) {
						(b = a.line + y) > e.lastLine() && e.replaceRange("\n", new t(b, 0)), ge(e, b) < a.ch && ye(e, b, a.ch)
					}
					e.setCursor(a), Ce(e, new t(a.line + v.length - 1, a.ch)), e.replaceSelections(v), p = a
				} else if(e.replaceRange(o, a), f) {
					var b = n.after ? a.line + 1 : a.line;
					p = new t(b, Le(e.getLine(b)))
				} else p = ue(a), /\n/.test(o) || (p.ch += o.length - (n.after ? 1 : 0));
				r.visualMode && Me(e, !1), e.setCursor(p)
			}
		},
		undo: function(t, n) {
			t.operation(function() {
				ce(t, e.commands.undo, n.repeat)(), t.setCursor(ie(t, t.getCursor("start")))
			})
		},
		redo: function(t, n) {
			ce(t, e.commands.redo, n.repeat)()
		},
		...
		insertRegister: function(e, t, n) {
			var r = t.selectedCharacter,
				o = E.registerController.getRegister(r),
				i = o && o.toString();
			i && e.replaceSelection(i)
		},
		oneNormalCommand: function(t, n, r) {
			at(t, !0), r.insertModeReturn = !0, e.on(t, "vim-command-done", function n() {
		...
		replace: function(r, o, i) {
			...
			if(c = d.start, s = d.end, "\n" == l) i.visualMode || r.replaceRange("", c, s), (e.commands.newlineAndIndentContinueComment || e.commands.newlineAndIndent)(r);
				...
				i.visualMode ? (c = de(u[0].anchor, u[0].head) ? u[0].anchor : u[0].head, r.setCursor(c), Me(r, !1)) : r.setCursor(se(s, 0, -1))
			}
		},
		...
		repeatLastEdit: function(e, t, n) {
			...
			if(r) {
				var o = t.repeat;
				o && t.repeatIsExplicit ? r.repeatOverride = o : o = r.repeatOverride || o, pt(e, n, o, !1)
			}
		},
		indent: function(e, t) {
	...
	function me(e, t) {
		return arguments.length > 2 && (t = me.apply(void 0, Array.prototype.slice.call(arguments, 1))), de(e, t) ? e : t
	}

	function pe(e, t) {
		return arguments.length > 2 && (t = pe.apply(void 0, Array.prototype.slice.call(arguments, 1))), de(e, t) ? t : e
	}
		...
		var r = [],
			...
			s = function(e, t) {
				for(var n = 0; n < e.length; n++) {
					var r = he(e[n].anchor, t),
						o = he(e[n].head, t);
					if(r || o) return n
				}
				return -1
			}(o, e.getCursor("head")),
			l = he(o[s].head, o[s].anchor),
			c = o.length - 1,
			u = c - s > s ? c : 0,
			h = o[u].anchor,
	...
	function ke(e, t) {
		var n = t.sel.anchor,
			r = t.sel.head;
		t.lastPastedText && (r = e.posFromIndex(e.indexFromPos(n) + t.lastPastedText.length), t.lastPastedText = void 0), t.lastSelection = {
	...
	function xe(e, n, r, o) {
		var i = ue(n.head),
			a = ue(n.anchor);
		if("char" == r) {
			var s = o || de(n.head, n.anchor) ? 0 : 1,
				l = de(n.head, n.anchor) ? 1 : 0;
			return i = se(n.head, 0, s), {
				ranges: [{
					anchor: a = se(n.anchor, 0, l),
					head: i
				}],
				primary: 0
			}
		...
		if("line" == r) {
			if(de(n.head, n.anchor)) i.ch = 0, a.ch = ge(e, a.line);
			else {
				a.ch = 0;
				var c = e.lastLine();
				i.line > c && (i.line = c), i.ch = ge(e, i.line)
			}
			return {
				ranges: [{
					anchor: a,
	...
	function Me(t, n) {
		var r = t.state.vim;
		!1 !== n && t.setCursor(ie(t, r.sel.head)), ke(t, r), r.visualMode = !1, r.visualLine = !1, r.visualBlock = !1, r.insertMode || e.signal(t, "vim-mode-change", {
			mode: "normal"
		})
	}
	...
	function be(e, {
		...
		var l, c = s || function(e) {
				...
				return 1 == e.getSelection().length && (t = me(t, e.getCursor("anchor"))), t
			}(e),
			d = e.getLine(c.line),
			m = d,
			p = c.line,
	...
	function Ae(e, t, n) {
		he(t, n) || E.jumpList.add(e, t, n)
	}

	function Ee(e, t) {
		E.lastCharacterSearch.increment = e, E.lastCharacterSearch.forward = t.forward, E.lastCharacterSearch.selectedCharacter = t.selectedCharacter
	}
	var Oe = {
			"(": "bracket",
			")": "bracket",
	...
	function Re(e, t, n, r, o) {
		var i = t.line,
			...
			c = r ? h : u;
		if(o && "" == s) {
			if(i += l, s = e.getLine(i), !g(e, i)) return null;
			a = n ? 0 : s.length
		}
		for(;;) {
			if(o && "" == s) return {
			...
			for(var d = l > 0 ? s.length : -1, m = d, p = d; a != d;) {
				for(var f = !1, v = 0; v < c.length && !f; ++v)
					if(c[v](s.charAt(a))) {
						...
						if(f = m != (p = a), m == t.ch && i == t.line && p == m + l) continue;
						return {
							from: Math.min(m, p + 1),
							to: Math.max(m, p),
							line: i
	...
	function Ne(e, n, r, o, i) {
		if(o) {
			for(var a, s = i || e.getCursor(), l = s.ch, c = 0; c < n; c++) {
				if(-1 == (a = Ke(l, e.getLine(s.line), o, r))) return;
				l = a
			}
			return null != a ? new t(e.getCursor().line, a) : void 0
		}
	}

	function Ie(e, t, n, r) {
		(x(n, d) || p.test(n)) && (t.marks[n] && t.marks[n].clear(), t.marks[n] = e.setBookmark(r))
	}
	...
	function Pe(e, n, r, o, i) {
		function a(e) {
			null !== e.line && (e.pos + e.dir < 0 || e.pos + e.dir >= e.line.length ? e.line = null : e.pos += e.dir)
		}
		...
		function s(e, t, n, r) {
			...
			var s = o.pos;
			for(a(o); null !== o.line;) {
				if(s = o.pos, S(o.line[o.pos])) {
					if(i) {
						for(a(o); null !== o.line && k(o.line[o.pos]);) s = o.pos, a(o);
						return {
							ln: o.ln,
							pos: s + 1
						}
		...
		function l(e, t, n, r) {
			...
			var l = s.pos;
			for(a(s); null !== s.line;) {
				if(k(s.line[s.pos]) || S(s.line[s.pos])) {
					if(S(s.line[s.pos])) return i && k(s.line[s.pos + 1]) ? {
						ln: s.ln,
						pos: s.pos + 1
					} : {
						ln: s.ln,
			...
			return s.line = o, i && k(s.line[s.pos]) ? {
				ln: s.ln,
				pos: s.pos
			} : {
				ln: s.ln,
	...
	function Ve(e) {
		var t = e.state.vim;
		return t.searchState_ || (t.searchState_ = new Fe)
	}
	...
	function Ue(e, t, n) {
		E.registerController.getRegister("/").setText(e);
		var r, o, i, a, s, l, c, u = $e(e, "/");
		u.length ? (r = e.substring(0, u[0]), o = -1 != e.substring(u[0]).indexOf("i")) : r = e;
		return r ? (A("pcre") || (a = {
			">": "(?<=[\\w])(?=[^\\w]|$)",
			"<": "(?<=[^\\w]|^)(?=[\\w])"
		}, s = (i = {
			...
			m: "|(){+?",
			v: "<>"
		}).m, l = r.replace(/\\.|[\[|(){+*?.$^<>]/g, function(e) {
			if("\\" === e[0]) {
				var t = e[1];
				return "}" === t || -1 != s.indexOf(t) ? t : t in i ? (s = i[t], "") : t in a ? a[t] : e
			}
			return -1 != s.indexOf(e) ? a[e] || "\\" + e : e
		}), -1 != (c = l.indexOf("\\zs")) && (l = "(?<=" + l.slice(0, c) + ")" + l.slice(c + 3)), -1 != (c = l.indexOf("\\ze")) && (l = l.slice(0, c) + "(?=" + l.slice(c + 3) + ")"), r = l), n && (t = /^[^A-Z]*$/.test(r)), new RegExp(r, t || o ? "im" : "m")) : null
	}
	...
	function qe(e) {
		...
		for(var t = 1; t < arguments.length; t++) {
			var n = arguments[t];
			if(n)
				if("object" != typeof n && (n = document.createTextNode(n)), n.nodeType) e.appendChild(n);
				else
					for(var r in n) Object.prototype.hasOwnProperty.call(n, r) && ("$" === r[0] ? e.style[r.slice(1)] = n[r] : "function" == typeof n[r] ? e[r] = n[r] : e.setAttribute(r, n[r]))
		}
		return e
	}
	...
	function Qe(e, t, n) {
		...
		e.openNotification ? n ? (r = qe("div", {}, r, qe("div", {}, "Press ENTER or type command to continue")), e.state.closeVimNotification && e.state.closeVimNotification(), e.state.closeVimNotification = e.openNotification(r, {
			bottom: !0,
			duration: 0
	...
	function ze(e, t) {
		if(H.length) return t.value || (t.value = ""), void(D = t);
		var n, r, o = (n = t.prefix, r = t.desc, qe("div", {
			$display: "flex",
			$flex: 1
		}, qe("span", {
	...
	function Je(e, t, n, r) {
		if(t) {
			var o, i, a = Ve(e),
				s = Ue(t, !!n, !!r);
			if(s) return Ge(e, s), o = s, i = a.getQuery(), o instanceof RegExp && i instanceof RegExp && o.flags == i.flags && o.source == i.source ? s : (a.setQuery(s), s)
		}
	}
	var Xe = 0;

	function Ge(e, t) {
		clearTimeout(Xe), Ve(e).highlightTimeout = Xe, Xe = setTimeout(function() {
			if(e.state.vim) {
				var n = Ve(e);
	...
	function Ye(e, n, r, o) {
		return e.operation(function() {
			...
			for(var i = e.getCursor(), a = e.getSearchCursor(r, i), s = 0; s < o; s++) {
				var l = a.find(n);
				if(0 == s && l && he(a.from(), i)) {
					var c = n ? a.from() : a.to();
					(l = a.find(n)) && !l[0] && he(a.from(), c) && e.getLine(c.line).length == c.ch && (l = a.find(n))
				}
	...
	function Ze(e) {
		var t = Ve(e);
		t.highlightTimeout && (clearTimeout(t.highlightTimeout), t.highlightTimeout = void 0), e.removeOverlay(Ve(e).getOverlay()), t.setOverlay(null), t.getScrollbarAnnotate() && (t.getScrollbarAnnotate().clear(), t.setScrollbarAnnotate(null))
	}

	function et(e, t, n) {
		return "number" != typeof e && (e = e.line), t instanceof Array ? x(e, t) : "number" == typeof n ? e >= t && e <= n : e == t
	}
	...
	function nt(e, n, r) {
		if("'" == r || "`" == r) return E.jumpList.find(e, -1) || new t(0, 0);
		if("." == r) return rt(e);
		var o = n.marks[r];
		return o && o.find()
	}
	...
	function rt(e) {
		...
		for(var t = e.doc.history.done, n = t.length; n--;)
			if(t[n].changes) return ue(t[n].changes[0].to)
	}
	var ot = {
			colorscheme: function(e, t) {
				!t.args || t.args.length < 1 ? Qe(e, e.getOption("theme")) : e.setOption("theme", t.args[0])
			},
			map: function(e, t, n, r) {
				var o = t.args;
				!o || o.length < 2 ? e && Qe(e, "Invalid mapping: " + t.input) : it.map(o[0], o[1], n, r)
			},
			imap: function(e, t) {
				this.map(e, t, "insert")
			},
			...
			unmap: function(e, t, n) {
				var r = t.args;
				(!r || r.length < 1 || !it.unmap(r[0], n)) && e && Qe(e, "No such mapping: " + t.input)
			},
			...
			omapclear: function(e, t) {
				P.mapclear("operatorPending")
			},
			move: function(e, t) {
				ee.processCommand(e, e.state.vim, {
					keys: "",
					type: "motion",
					motion: "moveToLineOrEdgeOfDocument",
					motionArgs: {
			...
			set: function(e, t) {
				var n = t.args,
					r = t.setCfg || {};
				if(!n || n.length < 1) e && Qe(e, "Invalid mapping: " + t.input);
				else {
					var o = n[0].split("="),
						i = o.shift() || "",
					...
					var c = M[i] && "boolean" == M[i].type;
					if(c && (l ? a = !A(i, e, r) : null == a && (a = !0)), !c && void 0 === a || s) {
						var u = A(i, e, r);
						u instanceof Error ? Qe(e, u.message) : Qe(e, !0 === u || !1 === u ? " " + (u ? "" : "no") + i : "  " + i + "=" + u)
					} else {
						var h = b(i, a, e, r);
						h instanceof Error && Qe(e, h.message)
					}
				}
			},
			...
			registers: function(e, t) {
				var n = t.args,
					r = E.registerController.registers,
					o = "----------Registers----------\n\n";
				if(n)
					for(var i = n.join(""), a = 0; a < i.length; a++) {
						s = i.charAt(a);
						if(E.registerController.isValidRegister(s)) o += '"' + s + "    " + (r[s] || new G).toString() + "\n"
					} else
						for(var s in r) {
							var l = r[s].toString();
							l.length && (o += '"' + s + "    " + l + "\n")
			...
			marks: function(e, t) {
				...
				if(n)
					for(var i = n.join(""), a = 0; a < i.length; a++) {
						(l = r[s = i.charAt(a)] && r[s].find()) && (o += s + "\t" + l.line + "\t" + l.ch + "\n")
					} else
						for(var s in r) {
							var l;
							(l = r[s] && r[s].find()) && (o += s + "\t" + l.line + "\t" + l.ch + "\n")
						}
				Qe(e, o, !0)
			},
			sort: function(n, r) {
					...
					if(u != h) {
						...
						if(s || l)
							for(var C = 0; C < p.length; C++) {
								var w = l ? p[C].match(l) : null;
								w && "" != w[0] ? v.push(w) : f && f.exec(p[C]) ? v.push(p[C]) : y.push(p[C])
							} else y = p;
						...
						if(p = o ? v.concat(y) : y.concat(v), a) {
							var k, S = p;
							p = [];
							for(C = 0; C < S.length; C++) S[C] != k && p.push(S[C]), k = S[C]
						}
			...
			normal: function(e, t) {
				var n = !1,
					r = t.argString;
				if(r && "!" == r[0] && (r = r.slice(1), n = !0), r = r.trimStart()) {
					var o = t.line;
					if("number" == typeof o)
						for(var i = isNaN(t.lineEnd) ? o : t.lineEnd, a = o; a <= i; a++) e.setCursor(a, 0), j(e, t.argString.trimStart(), {
							noremap: n
						}), e.state.vim.insertMode && at(e, !0);
					else j(e, t.argString.trimStart(), {
						noremap: n
					}), e.state.vim.insertMode && at(e, !0)
				} else Qe(e, "Argument is required.")
			},
			global: function(e, t) {
				var n = t.argString;
				if(n) {
					...
					if(a && a.length && (s = a[0], l = a.slice(1, a.length).join("/")), s) try {
						...
						return void Qe(e, "Invalid regex: " + s)
					}
					for(var c = Ve(e).getQuery(), u = [], h = o; h <= i; h++) {
						var d = e.getLine(h);
				...
				} else Qe(e, "Regular Expression missing from global")
			},
			substitute: function(n, r) {
				...
				var o, i, a, s = r.argString,
					...
					h = !1,
					d = !1;
				if(l && l.length) c = l[0], A("pcre") && "" !== c && (c = new RegExp(c).source), void 0 !== (u = l[1]) && (u = A("pcre") ? function(t) {
					...
					for(var t = !1, n = [], r = -1; r < e.length; r++) {
						var o = e.charAt(r) || "",
							i = e.charAt(r + 1) || "";
						_e[o + i] ? (n.push(_e[o + i]), r++) : t ? (n.push(o), t = !1) : "\\" === o ? (t = !0, C(i) || "$" === i ? n.push("$") : "/" !== i && "\\" !== i && n.push("\\")) : ("$" === o && n.push("$"), n.push(o), "/" === i && n.push("\\"))
					}
					return n.join("")
				}(u), E.lastSubstituteReplacePart = u), o = l[2] ? l[2].split(" ") : [];
				else if(s && s.length) return void Qe(n, "Substitutions should be of the form :s/pattern/replace/");
				if(o && (i = o[0], a = parseInt(o[1]), i && (-1 != i.indexOf("c") && (h = !0), -1 != i.indexOf("g") && (d = !0), c = A("pcre") ? c + "/" + i : c.replace(/\//g, "\\/") + "/" + i)), c) try {
					Je(n, c, !0, !0)
				} catch (e) {
					return void Qe(n, "Invalid regex: " + c)
				}
				if(void 0 !== (u = u || E.lastSubstituteReplacePart)) {
					var m = Ve(n).getQuery(),
						p = void 0 !== r.line ? r.line : n.getCursor().line,
						f = r.lineEnd || p;
					p == n.firstLine() && f == n.lastLine() && (f = 1 / 0), a && (f = (p = f) + a - 1);
					var g = ie(n, new t(p, 0)),
						v = n.getSearchCursor(m, g);
					! function(t, n, r, o, i, a, s, l, c) {
						...
						function g() {
							var e = "",
								n = a.match || a.pos && a.pos.match;
							n ? e = l.replace(/\$(\d{1,3}|[$&])/g, function(e, t) {
								if("$" == t) return "$";
								if("&" == t) return n[0];
								for(var r = t; parseInt(r) >= n.length && r.length > 0;) r = r.slice(0, r.length - 1);
								return r ? n[r] + t.slice(r.length, t.length) : e
							}) : e = t.getRange(a.from(), a.to()).replace(s, l);
							var r = a.to().line;
							a.replace(e), h = a.to().line, i += h - r, d = h < r
						}

						function v() {
							var e = u && ue(a.to()),
								t = a.findNext();
							return t && !t[0] && e && he(a.from(), e) && (t = a.findNext()), t && p++, t
						}
						...
						function C(e) {
							...
							c ? c() : m && Qe(t, (p ? "Found " + p + " matches" : "No matches found") + " for pattern: " + s + (A("pcre") ? " (set nopcre to use Vim regexps)" : ""))
						}

						function w(n, r, o) {
							switch(e.e_stop(n), U(n)) {
								case "y":
									g(), y();
									break;
								case "n":
						...
						if(y(), m) return void Qe(t, "No matches for " + s + (A("pcre") ? " (set nopcre to use vim regexps)" : ""));
						if(!n) return f(), void(c && c());
						ze(t, {
							prefix: qe("span", "replace with ", qe("strong", l), " (y/n/a/q/l)"),
							onKeyDown: w
						})
					}(n, h, d, p, f, v, m, u, r.callback)
				} else Qe(n, "No previous substitute regular expression")
			},
			...
			yank: function(e) {
				var t = ue(e.getCursor()).line,
					n = e.getLine(t);
				E.registerController.pushText("0", "yank", n, !0, !0)
			},
			delete: function(e, n) {
			...
			join: function(e, n) {
				var r = n.selectionLine,
					o = isNaN(n.selectionLineEnd) ? r : n.selectionLineEnd;
				e.setCursor(new t(r, 0)), oe.joinLines(e, {
					repeat: o - r
				}, e.state.vim)
			},
			delmarks: function(t, n) {
				if(n.argString && ve(n.argString))
					for(var r = t.state.vim, o = new e.StringStream(ve(n.argString)); !o.eol();) {
						o.eatSpace();
						var i = o.pos;
						if(!o.match(/[a-zA-Z]/, !1)) return void Qe(t, "Invalid argument: " + n.argString.substring(i));
						var a = o.next();
						if(o.match("-", !0)) {
							if(!o.match(/[a-zA-Z]/, !1)) return void Qe(t, "Invalid argument: " + n.argString.substring(i));
							var s = a,
								l = o.next();
							if(!s || !l || v(s) != v(l)) return void Qe(t, "Invalid argument: " + s + "-");
							var c = s.charCodeAt(0),
								u = l.charCodeAt(0);
							if(c >= u) return void Qe(t, "Invalid argument: " + n.argString.substring(i));
							for(var h = 0; h <= u - c; h++) {
								var d = String.fromCharCode(c + h);
								delete r.marks[d]
							}
						} else a && delete r.marks[a]
					} else Qe(t, "Argument required")
			}
		},
		it = new class {
			constructor() {
			...
			_processCommand(t, n, r) {
				var o = t.state.vim,
					i = E.registerController.getRegister(":"),
					a = i.toString(),
				...
				if(o.visualMode && Me(t), u.commandName) {
					if(l = this.matchCommand_(u.commandName)) {
						if(c = l.name, l.excludeFromCommandHistory && i.setText(a), this.parseCommandArgs_(s, u, l), "exToKey" == l.type) return void j(t, l.toKeys || "", l);
						if("exToEx" == l.type) return void this.processCommand(t, l.toInput || "")
					}
				} else void 0 !== u.line && (c = "move");
				if(c) try {
					ot[c](t, u), l && l.possiblyAsync || !u.callback || u.callback()
				} catch (e) {
					throw Qe(t, e + ""), e
				} else Qe(t, 'Not an editor command ":' + n + '"')
			}
			parseInput_(e, t, n) {
				t.eatWhile(":"), t.eat("%") ? (n.line = e.firstLine(), n.lineEnd = e.lastLine()) : (n.line = this.parseLineSpec_(e, t), void 0 !== n.line && t.eat(",") && (n.lineEnd = this.parseLineSpec_(e, t))), null == n.line ? e.state.vim.visualMode ? (n.selectionLine = nt(e, e.state.vim, "<")?.line, n.selectionLineEnd = nt(e, e.state.vim, ">")?.line) : n.selectionLine = e.getCursor().line : (n.selectionLine = n.line, n.selectionLineEnd = n.lineEnd);
				var r = t.match(/^(\w+|!!|@@|[!#&*<=>@~])/);
			...
			map(e, t, n, r) {
				if(":" != e && ":" == e.charAt(0)) {
					...
					var o = e.substring(1);
					":" != t && ":" == t.charAt(0) ? this.commandMap_[o] = {
						name: o,
						type: "exToEx",
			...
			unmap(e, t) {
				if(":" != e && ":" == e.charAt(0)) {
					...
					for(var o = e, i = 0; i < r.length; i++)
						if(o == r[i].keys && r[i].context === t) return r.splice(i, 1), lt(o), !0
			}
		};
	...
	function ct(e, t, n, r) {
		var o = E.registerController.getRegister(r);
		if(":" == r) return o.keyBuffer[0] && it.processCommand(e, o.keyBuffer[0]), void(n.isPlaying = !1);
		var i = o.keyBuffer,
			a = 0;
		n.isPlaying = !0, n.replaySearchQueries = o.searchQueries.slice(0);
		for(var s = 0; s < i.length; s++)
			for(var l, c, u = i[s], h = /<(?:[CSMA]-)*\w+>|./gi; l = h.exec(u);)
				if(c = l[0], P.handleKey(e, c, "macro"), t.insertMode) {
					var d = o.insertModeChanges[a++].changes;
					E.macroModeState.lastInsertModeChanges.changes = d, gt(e, d, 1), at(e)
				} n.isPlaying = !1
	}
	...
	function ht(e) {
		...
		} else e.curOp?.isVimOp || dt(e, t)
	}

	function dt(t, n) {
		var r = t.getCursor("anchor"),
			o = t.getCursor("head");
		if(n.visualMode && !t.somethingSelected() ? Me(t, !1) : n.visualMode || n.insertMode || !t.somethingSelected() || (n.visualMode = !0, n.visualLine = !1, e.signal(t, "vim-mode-change", {
				mode: "visual"
			})), n.visualMode) {
			var i = de(o, r) ? 0 : -1,
				a = de(o, r) ? -1 : 0;
			o = se(o, 0, i), r = se(r, 0, a), n.sel = {
				anchor: r,
				head: o
			}, Ie(t, n, "<", me(o, r)), Ie(t, n, ">", pe(o, r))
		} else n.insertMode || (n.lastHPos = t.getCursor().ch)
	}

	function mt(t) {
		var n = E.macroModeState.lastInsertModeChanges,
			r = e.keyName ? e.keyName(t) : t.key;
		r && (-1 == r.indexOf("Delete") && -1 == r.indexOf("Backspace") || (n.maybeReset && (n.changes = [], n.maybeReset = !1), n.changes.push(new K(r, t))))
	}
	...
	function pt(e, t, n, r) {
		...
		function s() {
			i ? ee.processAction(e, t, i) : ee.evalInput(e, t)
		}
		...
		t.inputState = a, t.insertMode && !r && at(e), o.isPlaying = !1
	}
	...
	function gt(e, t, n) {
		var r = e.getCursor("head"),
			o = E.macroModeState.lastInsertModeChanges.visualBlock;
		o && (we(e, r, o + 1), n = e.listSelections().length, e.setCursor(r));
		for(var i = 0; i < n; i++) {
			o && e.setCursor(se(r, i, 0));
			for(var a = 0; a < t.length; a++) {
				var s = t[a];
				if(s instanceof K) ft(e, s.keyName);
				else if("string" == typeof s) e.replaceSelection(s);
				else {
					var l = e.getCursor(),
						c = se(l, 0, s[0].length - (s[1] || 0));
					e.replaceRange(s[0], l, s[1] ? l : c), e.setCursor(c)
				}
			}
		}
		o && e.setCursor(se(r, 0, 1))
	}
	...
	function vt(e) {
		...
		return Object.keys(e).forEach(function(n) {
			if("insertEnd" != n) {
				var r = e[n];
				Array.isArray(r) ? r = r.slice() : r && "object" == typeof r && r.constructor != Object && (r = vt(r)), t[n] = r
			}
		}), e.sel && (t.sel = {
			head: e.sel.head && ue(e.sel.head),
			anchor: e.sel.anchor && ue(e.sel.anchor)
		}), t
	}
	return P.defineEx("version", "ve", e => {
		Qe(e, "Codemirror-vim version: 6.3.0")
	}), L("insertModeEscKeysTimeout", 200, "number"), I(), P
}
...
let f;
try {
	f = new RegExp("[\\w\\p{Alphabetic}\\p{Number}_]", "u")
} catch (e) {
	f = /[\w]/
}
...
function v(e, t) {
	var n;
	e.curOp && (e.curOp.$changeStart = void 0), (t ? o.undo : o.redo)(e.cm6);
...
var y = {
	Left: e => n.runScopeHandlers(e.cm6, {
		key: "Left"
	}, "editor"),
	Right: e => n.runScopeHandlers(e.cm6, {
		key: "Right"
	}, "editor"),
	Up: e => n.runScopeHandlers(e.cm6, {
		key: "Up"
	}, "editor"),
	Down: e => n.runScopeHandlers(e.cm6, {
		key: "Down"
	}, "editor"),
	Backspace: e => n.runScopeHandlers(e.cm6, {
		key: "Backspace"
	}, "editor"),
	Delete: e => n.runScopeHandlers(e.cm6, {
		key: "Delete"
	}, "editor")
};
class C {
		...
		return function(e, t, n, r) {
			...
			function a(t) {
				if("string" == typeof t) s.value = t;
					...
					if(i) return;
					i = !0, x(e, o), e.state.dialog || e.focus(), r.onClose && r.onClose(o)
				}
			}
			S(e, o);
			var s = o.getElementsByTagName("input")[0];
			s && (r.value && (s.value = r.value, !1 !== r.selectValueOnOpen && s.select()), r.onInput && C.on(s, "input", function(e) {
				r.onInput(e, s.value, a)
			}), r.onKeyUp && C.on(s, "keyup", function(e) {
				r.onKeyUp(e, s.value, a)
			}), C.on(s, "keydown", function(e) {
				r && r.onKeyDown && r.onKeyDown(e, s.value, a) || (13 == e.keyCode && n && n(s.value), (27 == e.keyCode || !1 !== r.closeOnEnter && 13 == e.keyCode) && (s.blur(), C.e_stop(e), a()))
			}), !1 !== r.closeOnBlur && C.on(s, "blur", function() {
				setTimeout(function() {
	...
	openNotification(e, t) {
		return function(e, t, n) {
			...
			var r, o = w(e, t, n && n.bottom),
				i = !1,
				a = n && void 0 !== n.duration ? n.duration : 5e3;

			function s() {
				i || (i = !0, clearTimeout(r), o.remove(), x(e, o))
			}
	...
	foldCode(n) {
		let r = this.cm6,
			o = r.state.selection.ranges,
			i = l(this.cm6.state.doc, n),
			a = e.EditorSelection.create([e.EditorSelection.range(i, i)], 0).ranges;
		r.state.selection.ranges = a, t.foldCode(r), r.state.selection.ranges = o
	}
	firstLine() {
		return 0
	}
	...
	setSelections(t, n) {
		var r = this.cm6.state.doc,
			o = t.map(t => {
				var n = l(r, t.head),
					o = l(r, t.anchor);
				return n == o ? e.EditorSelection.cursor(n, 1) : e.EditorSelection.range(o, n)
			});
		this.cm6.dispatch({
			selection: e.EditorSelection.create(o, n)
		})
	}
	setSelection(e, t, n) {
		this.setSelections([{
	...
	getLineHandle(e) {
		return this.$lineHandleChanges || (this.$lineHandleChanges = []), {
			row: e,
			index: this.indexFromPos(new u(e, 0))
		}
	}
	getLineNumber(t) {
		var n = this.$lineHandleChanges;
		if(!n) return null;
		for(var r = t.index, o = 0; o < n.length; o++)
			if(null == (r = n[o].changes.mapPos(r, 1, e.MapMode.TrackAfter))) return null;
	...
	getRange(e, t) {
		...
		return this.cm6.state.sliceDoc(l(n, e), l(n, t))
	}
	...
	replaceSelection(e) {
		g(this, this.cm6.state.replaceSelection(e))
	}
	replaceSelections(e) {
		g(this, {
	...
	clipPos(e) {
		...
		var o = t.line(r);
		return n = Math.min(Math.max(0, n), o.to - o.from), new u(r - 1, n)
	}
	getValue() {
	...
	setValue(t) {
		...
		return n.dispatch({
			...
			selection: e.EditorSelection.range(0, 0)
		})
	}
	focus() {
	...
	findMatchingBracket(e, n) {
		var r = this.cm6.state,
			o = l(r.doc, e),
			i = t.matchBrackets(r, o + 1, -1);
		return i && i.end || (i = t.matchBrackets(r, o, 1)) && i.end ? {
			to: c(r.doc, i.end.from)
		} : {
			to: void 0
		}
	}
	scanForBracket(e, t, n, r) {
		return function(e, t, n, r, o) {
			for(var i = o && o.maxScanLineLength || 1e4, a = o && o.maxScanLines || 1e3, s = [], l = function(e) {
				...
				}(o), c = n > 0 ? Math.min(t.line + a, e.lastLine() + 1) : Math.max(e.firstLine() - 1, t.line - a), h = t.line; h != c; h += n) {
				var d = e.getLine(h);
				if(d) {
					var m = n > 0 ? 0 : d.length - 1,
						p = n > 0 ? d.length : -1;
					if(!(d.length > i))
						for(h == t.line && (m = t.ch - (n < 0 ? 1 : 0)); m != p; m += n) {
							var f = d.charAt(m);
							if(l.test(f)) {
								var g = M[f];
	...
	indentMore() {
		o.indentMore(this.cm6)
	}
	indentLess() {
		o.indentLess(this.cm6)
	}
	execCommand(e) {
		if("indentAuto" == e) C.commands.indentAuto(this);
		else if("goLineLeft" == e) o.cursorLineBoundaryBackward(this.cm6);
		else if("goLineRight" == e) {
			o.cursorLineBoundaryForward(this.cm6);
			let e = this.cm6.state,
				t = e.selection.main.head;
			t < e.doc.length && "\n" !== e.sliceDoc(t, t + 1) && o.cursorCharBackward(this.cm6)
		} else console.log(e + " is not implemented")
	}
	setBookmark(e, t) {
		var n = (null == t ? void 0 : t.insertLeft) ? 1 : -1,
			r = this.indexFromPos(e);
		return new b(this, r, n)
	}
	addOverlay({
		query: e
	}) {
		let t = new r.SearchQuery({
			regexp: !0,
			search: e.source,
	...
	removeOverlay(e) {
		...
		let t = r.setSearchQuery.of(this.cm6Query);
		this.cm6.dispatch({
			effects: t
		})
	}
	getSearchCursor(e, t) {
		...
		var s = l(n.cm6.state.doc, t),
			u = e.source.replace(/(\\.|{(?:\d+(?:,\d*)?|,\d+)})|[{}]/g, function(e, t) {
				return t || "\\" + e
			});

		function h(t, n = 0, o = t.length) {
			return new r.RegExpCursor(t, u, {
		...
		return {
			...
			find: function(e) {
				...
				return i = o && {
					...
					to: c(t, o.to),
					match: o.match
				}, a = !!o && o.from == o.to, o && o.match
			},
			from: function() {
				return null == i ? void 0 : i.from
			},
			to: function() {
				return null == i ? void 0 : i.to
			},
			replace: function(e) {
				o && (g(n, {
					changes: {
				...
				}), o.to = o.from + e.length, i && (i.to = c(n.cm6.state.doc, o.to)))
			},
			get match() {
				return i && i.match
			}
	...
	findPosV(t, n, r, o) {
		...
		const a = i.state.doc;
		let s = "page" == r ? i.dom.clientHeight : 0;
		const u = l(a, t);
		let h = e.EditorSelection.cursor(u, 1, void 0, o),
			d = Math.round(Math.abs(n));
		for(let e = 0; e < d; e++) "page" == r ? h = i.moveVertically(h, n > 0, s) : "line" == r && (h = i.moveVertically(h, n > 0));
		let m = c(a, h.head);
		return (n < 0 && 0 == h.head && 0 != o && 0 == t.line && 0 != t.ch || n > 0 && h.head == a.length && m.ch != o && t.line == m.line) && (m.hitSide = !0), m
	}
	charCoords(e, t) {
		var n = this.cm6.contentDOM.getBoundingClientRect(),
			r = l(this.cm6.state.doc, e),
			o = this.cm6.coordsAtPos(r),
			i = -n.top;
		return {
			left: ((null == o ? void 0 : o.left) || 0) - n.left,
			top: ((null == o ? void 0 : o.top) || 0) + i,
			bottom: ((null == o ? void 0 : o.bottom) || 0) + i
		}
	}
	coordsChar(e, t) {
		var n = this.cm6.contentDOM.getBoundingClientRect(),
	...
	scrollIntoView(e, t) {
		if(e) {
			...
			this.cm6.dispatch({
				effects: n.EditorView.scrollIntoView(r)
			})
	...
	onBeforeEndOperation() {
		var e = this.curOp,
			t = !1;
		e && (e.change && p(e.changeHandlers, this, e.change), e && e.cursorActivity && (p(e.cursorActivityHandlers, this, null), e.isVimOp && (t = !0)), this.curOp = null), t && this.scrollIntoView()
	}
	moveH(e, t) {
		if("char" == t) {
	...
	getOption(e) {
		switch(e) {
			...
			case "indentWithTabs":
				return "\t" == this.cm6.state.facet(t.indentUnit);
			case "indentUnit":
				return this.cm6.state.facet(t.indentUnit).length || 2;
			case "textwidth":
	...
	getTokenTypeAt(e) {
		var n, r = this.indexFromPos(e),
			o = t.ensureSyntaxTree(this.cm6.state, r),
			i = null == o ? void 0 : o.resolve(r),
			a = (null === (n = null == i ? void 0 : i.type) || void 0 === n ? void 0 : n.name) || "";
		return /comment/i.test(a) ? "comment" : /string/i.test(a) ? "string" : ""
	}
	overWriteSelection(t) {
		var n = this.cm6.state.doc,
			r = this.cm6.state.selection,
			o = r.ranges.map(t => {
				if(t.empty) {
					var r = t.to < n.length ? n.sliceString(t.from, t.to + 1) : "";
					if(r && !/\n/.test(r)) return e.EditorSelection.range(t.from, t.to + 1)
				}
				return t
			});
		this.cm6.dispatch({
			selection: e.EditorSelection.create(o, r.mainIndex)
	...
	forEachSelection(t) {
		...
		this.virtualSelection = e.EditorSelection.create(n.ranges, n.mainIndex);
		for(var r = 0; r < this.virtualSelection.ranges.length; r++) {
			var o = this.virtualSelection.ranges[r];
			o && (this.cm6.dispatch({
				selection: e.EditorSelection.create([o])
			}), t(), this.virtualSelection.ranges[r] = this.cm6.state.selection.ranges[0])
		}
		this.cm6.dispatch({
			...
			for(; i <= a;) {
				...
				if(s.length > r) {
					if(h = f(s, r, 5)) {
						...
						e.replaceRange("\n" + l, new u(i, h.start), new u(i, h.end))
					}
					a++
					...
					if(c && /\S/.test(c)) {
						var h, d = s.replace(/\s+$/, ""),
							m = c.replace(/^\s+/, ""),
							p = d + " " + m;
						(h = f(p, r, 5)) && h.start > d.length || p.length < r ? (e.replaceRange(" ", new u(i, d.length), new u(i + 1, c.length - m.length)), i--, a--) : d.length < s.length && e.replaceRange("", new u(i, d.length), new u(i, s.length))
					}
				}
				i++
			}
...
function S(e, t) {
	...
	e.state.dialog = t, t.style.flex = "1", t && n !== t && (n && n.contains(document.activeElement) && e.focus(), n && n.parentElement ? n.parentElement.replaceChild(t, n) : n && n.remove(), C.signal(e, "dialog"))
}

function x(e, t) {
	e.state.dialog == t && (e.state.dialog = null, C.signal(e, "dialog"))
}
C.isMac = "undefined" != typeof navigator && /Mac/.test(navigator.platform), C.Pos = u, C.StringStream = t.StringStream, C.commands = {
	cursorCharLeft: function(e) {
		o.cursorCharLeft(e.cm6)
	},
	redo: function(e) {
		v(e, !1)
	},
	...
	newlineAndIndent: function(e) {
		o.insertNewlineAndIndent({
			state: e.cm6.state,
			dispatch: t => g(e, t)
		})
	},
	indentAuto: function(e) {
		o.indentSelection(e.cm6)
	},
	newlineAndIndentContinueComment: void 0,
	save: void 0
}, C.isWordChar = function(e) {
	return f.test(e)
}, C.keys = y, C.addClass = function(e, t) {}, C.rmClass = function(e, t) {}, C.e_preventDefault = function(e) {
	e.preventDefault()
}, C.e_stop = function(e) {
	var t, n;
	null === (t = null == e ? void 0 : e.stopPropagation) || void 0 === t || t.call(e), null === (n = null == e ? void 0 : e.preventDefault) || void 0 === n || n.call(e)
}, C.lookupKey = function(e, t, n) {
	var r = C.keys[e];
	!r && /^Arrow/.test(e) && (r = C.keys[e.slice(5)]), r && n(r)
}, C.on = h, C.off = d, C.signal = m, C.findMatchingTag = function(e, t) {
	return null
}, C.findEnclosingTag = function(e, n) {
	var r, o, i = e.cm6.state,
		a = e.indexFromPos(n);
	if(a < i.doc.length) {
		"<" == i.sliceDoc(a, a + 1) && a++
	}
	var s = t.ensureSyntaxTree(i, a),
		l = (null == s ? void 0 : s.resolve(a)) || null;
	for(; l;) {
		if("OpenTag" == (null === (r = l.firstChild) || void 0 === r ? void 0 : r.type.name) && "CloseTag" == (null === (o = l.lastChild) || void 0 === o ? void 0 : o.type.name)) return {
			open: L(i.doc, l.firstChild),
			close: L(i.doc, l.lastChild)
		};
		l = l.parent
	}
}, C.keyName = void 0;
...
class b {
	...
	update(t) {
		null != this.offset && (this.offset = t.mapPos(this.offset, this.assoc, e.MapMode.TrackDel))
	}
}
let A = a.getDrawSelectionConfig || function() {
	let e = {
...
class O {
	...
	setBlinkRate() {
		let e = A(this.cm.cm6.state).cursorBlinkRate;
	...
	update(e) {
		...
		function(e) {
			return A(e.startState) != A(e.state)
		}(e) && this.setBlinkRate()
	}
	scheduleRedraw() {
...
const T = {
	...
	R = e.Prec.highest(n.EditorView.theme(T));
...
function B(e, t, r, o) {
	...
	let c = r.head,
		...
		h = 1,
		d = e.state.vim;
	if(d && (!d.insertMode || e.state.overwrite)) {
		if(u = !0, d.visualBlock && !o) return null;
		if(r.anchor < r.head) {
			"\n" != (c < t.state.doc.length && t.state.sliceDoc(c, c + 1)) && c--
		}
		e.state.overwrite ? h = .2 : d.status && (h = .5)
	}
	if(u) {
		let e = c < t.state.doc.length && t.state.sliceDoc(c, c + 1);
		e && /[\uDC00-\uDFFF]/.test(e) && c > 1 && (c--, e = t.state.sliceDoc(c, c + 1));
		let r = t.coordsAtPos(c, 1);
		if(!r) return null;
		let u = function(e) {
				let t = e.scrollDOM.getBoundingClientRect();
				return {
					left: (e.textDirection == n.Direction.LTR ? t.left : t.right - e.scrollDOM.clientWidth) - e.scrollDOM.scrollLeft * e.scaleX,
					top: t.top - e.scrollDOM.scrollTop * e.scaleY
				}
			}(t),
			d = t.domAtPos(c),
			p = d ? d.node : t.contentDOM;
		for(p instanceof Text && d.offset >= p.data.length && (null === (i = p.parentElement) || void 0 === i ? void 0 : i.nextSibling) && (p = null === (a = p.parentElement) || void 0 === a ? void 0 : a.nextSibling, d = {
				node: p,
				offset: 0
			}); d && d.node instanceof HTMLElement;) p = d.node, d = {
			node: d.node.childNodes[d.offset],
			offset: 0
		};
		...
		let f = getComputedStyle(p),
			g = r.left,
			v = null === (l = (s = t).coordsForChar) || void 0 === l ? void 0 : l.call(s, c);
		if(v && (g = v.left), e && "\n" != e && "\r" != e)
			if("\t" == e) {
				e = " ";
				var m = t.coordsAtPos(c + 1, -1);
				m && (g = m.left - (m.left - r.left) / parseInt(f.tabSize))
			} else /[\uD800-\uDBFF]/.test(e) && c < t.state.doc.length - 1 && (e += t.state.sliceDoc(c + 1, c + 2));
		else e = " ";
		let y = r.bottom - r.top;
		return new E((g - u.left) / t.scaleX, (r.top - u.top + y * (1 - h)) / t.scaleY, y * h / t.scaleY, f.fontFamily, f.fontSize, f.fontWeight, f.color, o ? "cm-fat-cursor cm-cursor-primary" : "cm-fat-cursor cm-cursor-secondary", e, 1 != h)
	}
	return null
}
var N = "undefined" != typeof navigator && /linux/i.test(navigator.platform) && / Gecko\/\d+/.exec(navigator.userAgent);
const I = s(C),
	K = n.EditorView.baseTheme({
	...
	D = n.ViewPlugin.fromClass(class {
		constructor(e) {
			this.status = "", this.query = null, this.decorations = n.Decoration.none, this.waitForCopy = !1, this.lastKeydown = "", this.useNextTextInput = !1, this.compositionText = "", this.view = e;
			const t = this.cm = new C(e);
			I.enterVimMode(this.cm), this.view.cm = this.cm, this.cm.state.vimPlugin = this, this.blockCursor = new O(e, t), this.updateClass(), this.cm.on("vim-command-done", () => {
				...
				this.cm.state.statusbar ? this.updateStatus() : e.dispatch({
					effects: H.of(!!this.cm.state.dialog)
				})
				...
				I.handleKey(this.cm, "<Esc>", "user"), this.cm.focus()
		...
		destroy() {
			I.leaveVimMode(this.cm), this.updateClass(), this.blockCursor.destroy(), delete this.view.cm
		}
		highlight(t) {
			if(this.query = t, !t) return this.decorations = n.Decoration.none;
			let {
				view: r
			} = this, o = new e.RangeSetBuilder;
			for(let e = 0, n = r.visibleRanges, i = n.length; e < i; e++) {
				let {
					from: a,
					to: s
				} = n[e];
				for(; e < i - 1 && s > n[e + 1].from - 500;) s = n[++e].to;
				t.highlight(r.state, a, s, (e, t) => {
					o.add(e, t, P)
				})
			}
			return this.decorations = o.finish()
		}
		handleKey(e, t) {
			const n = this.cm;
			let r = n.state.vim;
			if(!r) return;
			const o = I.vimKeyFromEvent(e, r);
			if(C.signal(this.cm, "inputEvent", {
					type: "handleKey",
					key: o
				}), !o) return;
			...
			if("<C-c>" === o && !C.isMac && n.somethingSelected()) return this.waitForCopy = !0, !0;
			r.status = (r.status || "") + o;
			let i = I.multiSelectHandleKey(n, o, "user");
			return r = I.maybeInitVimState_(n), !i && r.insertMode && n.state.overwrite && (e.key && 1 == e.key.length && !/\n/.test(e.key) ? (i = !0, n.overWriteSelection(e.key)) : "Backspace" == e.key && (i = !0, C.commands.cursorCharLeft(n))), i && (C.signal(this.cm, "vim-keypress", o), e.preventDefault(), e.stopPropagation(), this.blockCursor.scheduleRedraw()), this.updateStatus(), !!i
		}
	}, {
		eventHandlers: {
			copy: function(e, t) {
				this.waitForCopy && (this.waitForCopy = !1, Promise.resolve().then(() => {
					...
					t && (t.insertMode ? e.setSelection(e.getCursor(), e.getCursor()) : e.operation(() => {
						e.curOp && (e.curOp.isVimOp = !0), I.handleKey(e, "<Esc>", "user")
					}))
				}))
			},
			compositionstart: function(e, t) {
				this.useNextTextInput = !0, C.signal(this.cm, "inputEvent", e)
			},
			compositionupdate: function(e, t) {
				C.signal(this.cm, "inputEvent", e)
			},
			compositionend: function(e, t) {
				C.signal(this.cm, "inputEvent", e)
			},
			keypress: function(e, t) {
				C.signal(this.cm, "inputEvent", e), "Dead" == this.lastKeydown && this.handleKey(e, t)
			},
			keydown: function(e, t) {
				C.signal(this.cm, "inputEvent", e), this.lastKeydown = e.key, "Unidentified" == this.lastKeydown || "Process" == this.lastKeydown || "Dead" == this.lastKeydown ? this.useNextTextInput = !0 : (this.useNextTextInput = !1, this.handleKey(e, t))
			}
		},
		provide: () => [n.EditorView.inputHandler.of((e, t, n, r) => {
			var o, i, a = $(e);
			if(!a) return !1;
...
const P = n.Decoration.mark({
		class: "cm-searchMatch"
	}),
	H = e.StateEffect.define(),
	F = e.StateField.define({
		create: () => !1,
		update(e, t) {
			for(let n of t.effects) n.is(H) && (e = n.value);
			return e
		},
		provide: e => n.showPanel.from(e, e => e ? V : null)
	});
...
exports.CodeMirror = C, exports.Vim = I, exports.getCM = $, exports.vim = function(e = {}) {
	return [K, D, R, e.status ? n.showPanel.of(j) : F]
};
