...
class x {
	constructor(t, e, s, r) {
		this.parser = t, this.input = e, this.ranges = r, this.recovering = 0, this.nextStackID = 9812, this.minStackPos = 0, this.reused = [], this.stoppedAt = null, this.lastBigReductionStart = -1, this.lastBigReductionSize = 0, this.bigReductionCount = 0, this.stream = new c(e, r), this.tokens = new O(t, this.stream), this.topTerm = t.top[1];
		let {
			from: h
		} = r[0];
...
class P extends t.Parser {
	constructor(e) {
		...
		this.specializers = this.specializerSpecs.map(C), this.states = o(e.states, Uint32Array), this.data = o(e.stateData), this.goto = o(e.goto), this.maxTerm = e.maxTerm, this.tokenizers = e.tokenizers.map(t => "number" == typeof t ? new u(n, t) : t), this.topRules = e.topRules, this.dialects = e.dialects || {}, this.dynamicPrecedences = e.dynamicPrecedences || null, this.tokenPrecTable = e.tokenPrec, this.termNames = e.termNames || null, this.maxNode = this.nodeSet.types.length - 1, this.dialect = this.parseDialect(), this.top = this.topRules[Object.keys(this.topRules)[0]]
	}
	createParse(t, e, s) {
	...
	configure(t) {
		let e = Object.assign(Object.create(P.prototype), this);
...
exports.csvLanguage = void 0, exports.csvLanguage = e.LRLanguage.define({
	parser: R.configure({
		props: [s.styleTags({
			Separator: s.tags.separator,
			Cell1: s.tags.string,
			Cell2: s.tags.keyword,
			Cell3: s.tags.number,
			Cell4: s.tags.definition(s.tags.variableName),
			Cell5: s.tags.typeName
		})]
	})
}), exports.csv = function() {
	return new e.LanguageSupport(exports.csvLanguage)
};
