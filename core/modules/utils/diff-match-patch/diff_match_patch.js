...
diff_match_patch.prototype.diff_linesToChars_ = function (a, b) {
	function c(a) {
		for (var b = "", c = 0, f = -1, g = d.length; f < a.length - 1; ) {
			...
			c = f + 1;
			(e.hasOwnProperty ? e.hasOwnProperty(h) : void 0 !== e[h])
				? (b += String.fromCharCode(e[h]))
				: ((b += String.fromCharCode(g)), (e[h] = g), (d[g++] = h));
		}
		return b;
	}
	var d = [],
					...
					? (0 !== c &&
							...
							0 !== g &&
								(0 < b - c - d && a[b - c - d - 1][0] == DIFF_EQUAL
									...
									: (a.splice(0, 0, [DIFF_EQUAL, f.substring(0, g)]), b++),
								(f = f.substring(g)),
								(e = e.substring(g))),
		...
		if (-1 == k) (e[f] = !1), (d -= a[f].length2 - a[f].length1);
			...
			for (l = 0; l < a[f].diffs.length; l++) {
				...
				p[0] === DIFF_INSERT
					...
					: p[0] === DIFF_DELETE &&
						(b = b.substring(0, k + m) + b.substring(k + this.diff_xIndex(g, h + p[1].length)));
...
diff_match_patch.prototype.patch_addPadding = function (a) {
	...
	if (0 == e.length || e[0][0] != DIFF_EQUAL)
		e.unshift([DIFF_EQUAL, c]), (d.start1 -= b), (d.start2 -= b), (d.length1 += b), (d.length2 += b);
