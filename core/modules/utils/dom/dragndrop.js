	...
	$tw.utils.addEventListeners(domNode, [
		{
			...
			handlerFunction: function (event) {
				...
				if (
					titles.length > 0 &&
					((options.selector && $tw.utils.domMatchesSelector(event.target, options.selector)) ||
					...
					inner.appendChild(
						options.widget.document.createTextNode(
							titles.length === 1 ? titles[0] : titles.length + " tiddlers"
						)
					);
