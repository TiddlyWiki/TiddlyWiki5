...
exports.getTiddlerData = function(titleOrTiddler,defaultData) {
	...
	if(tiddler && tiddler.fields.text && tiddler.fields.type && $tw.Wiki.dataTiddlerSerializerModules[tiddler.fields.type]) {
		return $tw.Wiki.dataTiddlerSerializerModules[tiddler.fields.type].parse(tiddler);
	}
	return defaultData;
};
...
exports.setTiddlerData = function(title,data,fields,options) {
	...
	if(existingTiddler && existingTiddler.fields.type && $tw.Wiki.dataTiddlerSerializerModules[existingTiddler.fields.type]){
		newFields.type = existingTiddler.fields.type;
	} else {
		newFields.type = "application/json";
	}

	newFields.text = $tw.Wiki.dataTiddlerSerializerModules[newFields.type].stringify(newFields, data);
