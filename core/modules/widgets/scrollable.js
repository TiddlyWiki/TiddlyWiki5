...
ScrollableWidget.prototype.handleScrollEvent = function (event) {
	...
	if (
		...
		this.outerDomNode.scrollHeight <= this.outerDomNode.offsetHeight &&
		this.fallthrough === "yes"
	) {
		return true;
	}
	var options = {};
...
ScrollableWidget.prototype.render = function (parent, nextSibling) {
	var self = this;
	this.scaleFactor = 1;
	this.addEventListeners([{type: "tm-scroll", handler: "handleScrollEvent"}]);
	if ($tw.browser) {
...
ScrollableWidget.prototype.listenerFunction = function (event) {
	...
	this.timeout = setTimeout(function () {
		...
		if (
			!existingTiddler ||
			existingTiddler.fields["title"] !== newTiddlerFields["title"] ||
			existingTiddler.fields["scroll-left"] !== newTiddlerFields["scroll-left"] ||
			existingTiddler.fields["scroll-top"] !== newTiddlerFields["scroll-top"]
		) {
