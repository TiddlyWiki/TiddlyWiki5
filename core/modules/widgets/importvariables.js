...
class ImportVariablesWidget extends Widget {
	...
	*/
	refresh(changedTiddlers) {
		...
		var changedAttributes = this.computeAttributes(), tiddlerList = this.wiki.filterTiddlers(this.getAttribute("filter"), this);
