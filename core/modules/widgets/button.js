...
class ButtonWidget extends Widget {
	...
	*/
	render(parent, nextSibling) {
		var self = this, tag = "button", domNode;
		// Remember parent
		...
		// Assign classes
		var classes = this["class"].split(" ") || [], isPoppedUp = (this.popup || this.popupTitle) && this.isPoppedUp();
	...
	*/
	...
	updateDomNodeClasses() {
		var domNodeClasses = this.domNode.className.split(" "), oldClasses = this.class.split(" "), newClasses;
		this["class"] = this.getAttribute("class", "");
