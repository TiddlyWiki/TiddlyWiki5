...
class ElementWidget extends Widget {
	...
	*/
	render(parent, nextSibling) {
		...
		var XHTML_NAMESPACE = "http://www.w3.org/1999/xhtml", tagNamespaces = {
	...
	*/
	refresh(changedTiddlers) {
		var changedAttributes = this.computeAttributes(), hasChangedAttributes = $tw.utils.count(changedAttributes) > 0;
