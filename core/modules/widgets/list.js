...
class ListWidget extends Widget {
	...
	*/
	...
	getEmptyMessage() {
		var parser, emptyMessage = this.getAttribute("emptyMessage");
	...
	*/
	makeJoinTemplate() {
		var parser, join = this.getAttribute("join", "");
		if (join) {
	...
	*/
	makeItemTemplate(title, index) {
		// Check if the tiddler is a draft
		var tiddler = this.wiki.getTiddler(title), isDraft = tiddler && tiddler.hasField("draft.of"), template = this.template, join = this.join, templateTree;
	...
	*/
	refresh(changedTiddlers) {
		var changedAttributes = this.computeAttributes(), result;
		// Call the storyview
	...
	*/
	handleListChanges(changedTiddlers) {
		// Get the new list
...
class ListItemWidget extends Widget {
	...
	*/
	execute() {
		...
		// Add join if needed
		var children = this.parseTreeNode.children, join = this.parseTreeNode.join;
...
*/
class ListTemplateWidget extends Widget {
	constructor(parseTreeNode, options) {
		super();
		// Main initialisation inherited from widget.js
		this.initialise(parseTreeNode, options);
...
class ListEmptyWidget extends Widget {
	constructor(parseTreeNode, options) {
		super();
		// Main initialisation inherited from widget.js
		this.initialise(parseTreeNode, options);
...
class ListJoinWidget extends Widget {
	constructor(parseTreeNode, options) {
		super();
		// Main initialisation inherited from widget.js
		this.initialise(parseTreeNode, options);
