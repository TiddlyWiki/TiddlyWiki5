...
TestCaseWidget.prototype.render = function (parent, nextSibling) {
	...
	if (
		this.testcaseTestOutput &&
		this.testcaseWiki.tiddlerExists(this.testcaseTestOutput) &&
		this.testcaseTestExpectedResult &&
		this.testcaseWiki.tiddlerExists(this.testcaseTestExpectedResult)
	) {
		shouldRunTests = true;
	}
