...
CheckboxWidget.prototype.handleChangeEvent = function (event) {
	...
	if (hasChanged) {
		if (this.checkboxIndex) {
			...
			var listIndexValue =
				listContents && listContents.length ? $tw.utils.stringifyList(listContents) : undefined;
