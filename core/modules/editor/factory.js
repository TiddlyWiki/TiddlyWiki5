...
function editTextWidgetFactory(toolbarEngine,nonToolbarEngine) {
	...
	*/
	EditTextWidget.prototype.execute = function() {
		...
		this.editInputManagement = this.getAttribute("inputManagement") === "yes";
	...
	*/
	EditTextWidget.prototype.refresh = function(changedTiddlers) {
		...
		if(changedAttributes.tiddler || changedAttributes.field || changedAttributes.index || changedAttributes["default"] || changedAttributes["class"] || changedAttributes.placeholder || changedAttributes.size || changedAttributes.autoHeight || changedAttributes.minHeight || changedAttributes.focusPopup ||  changedAttributes.rows || changedAttributes.tabindex || changedAttributes.cancelPopups || changedAttributes.inputActions || changedAttributes.refreshTitle || changedAttributes.inputManagement || changedTiddlers[HEIGHT_MODE_TITLE] || changedTiddlers[ENABLE_TOOLBAR_TITLE]) {
			this.refreshSelf();
			return true;
