...
exports["excise"] = function(event,operation) {
	...
	const wikiLinks = !isMarkdown(editTiddler.fields.type);
	const excisionBaseTitle = $tw.language.getString("Buttons/Excise/DefaultTitle");
	if(editTiddler && editTiddler.fields["draft.of"]) {
		editTiddlerTitle = editTiddler.fields["draft.of"];
	}
	const excisionTitle = event.paramObject.title || this.wiki.generateNewTitle(excisionBaseTitle);
