...
function KeyboardManager(options) {
	...
	(this.shortcutKeysList =
		[]), // Stores the shortcut-key descriptors
		(this.shortcutActionList =
			[]), // Stores the corresponding action strings
...
KeyboardManager.prototype.updateShortcutLists = function (tiddlerList) {
	...
	for (var i = 0; i < tiddlerList.length; i++) {
		...
		this.shortcutParsedList[i] =
			this.shortcutKeysList[i] !== undefined ? this.parseKeyDescriptors(this.shortcutKeysList[i]) : undefined;
