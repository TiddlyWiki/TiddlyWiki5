...
exports.generateTiddlerFileInfo = function(tiddler,options) {
	...
	if(hasUnsafeFields) {
		...
		if(tiddlerType === "text/vnd.tiddlywiki" || tiddlerType === "text/vnd.tiddlywiki-multiple" || tiddlerType === "text/vnd.tiddlywiki-multiple+fields" || tiddler.hasField("_canonical_uri")) {
			// Save as a .tid file
